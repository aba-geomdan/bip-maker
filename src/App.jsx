...
const MAS = {
  ...
  // 검단ABA 실제 사용 양식 순서: 기능별 블록 (감각 1-4 / 회피 5-8 / 관심 9-12 / 획득 13-16)
  items: [
    { q: "위의 행동은 오랜 시간 혼자 있을 때 나타납니까?", f: "sensory" },        // 1 감각
    { q: "주변에 아무도 없으면 아주 오랜 시간동안 반복적으로 일어납니까?", f: "sensory" }, // 2 감각
    { q: "위의 행동을 하는 것을 즐기는 것으로 보입니까?(소리, 냄새, 맛, 시각적 즐거움)", f: "sensory" }, // 3 감각
    { q: "위의 행동이 발생 할 때, 주위에서 일어나는 일을 의식하지 못합니까?", f: "sensory" }, // 4 감각
    { q: "위의 행동은 어려운 과업 수행을 요구 받을 때 일어납니까?", f: "escape" },   // 5 회피
    { q: "위의 행동은 어떤 요구를 할 때 일어납니까?", f: "escape" },              // 6 회피
    { q: "어떤 것을 요구 할 때, 상대방을 당황스럽거나 화나게 하려고 위의 행동을 하는 것 같습니까?", f: "escape" }, // 7 회피
    { q: "주어진 과제를 멈춘 후(1~5분 내) 위의 행동이 중지됩니까?", f: "escape" }, // 8 회피
    { q: "위의 행동은 다른 사람들과 이야기 하고 있을 때 일어납니까?", f: "attention" }, // 9 관심
    { q: "위의 행동은 대상자에게서 관심을 다른 데로 돌릴 때 일어납니까?", f: "attention" }, // 10 관심
    { q: "관심을 주지 않을 때, 상대방을 당황스럽거나 화나게 하려고 위의 행동을 하는 것 같습니까?", f: "attention" }, // 11 관심
    { q: "상대방(타인)과 함께 시간을 보내기 위해 위의 행동을 하는 것 같습니까?", f: "attention" }, // 12 관심
    { q: "위의 행동은 가질 수(먹을 수, 할 수) 없다고 알고 있는 물건, 음식, 활동 등을 얻고자(먹고자, 하고자) 할 때 일어납니까?(제한된 것을 얻고, 하고 싶을 때)", f: "tangible" }, // 13 획득
    { q: "위의 행동은 좋아하는 음식, 활동, 물건 등을 제거했을 때 일어납니까?", f: "tangible" }, // 14 획득
    { q: "위의 행동은 요구 사항(물건, 음식, 활동 등)이 제공된 후에 짧게라도 행동이 멈추었습니까?", f: "tangible" }, // 15 획득
