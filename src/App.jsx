...
function visualCardToHtml(card, esc) {
  ...
  if (card.type === "volcano") {
    return frame(`<table style="width:100%;border-collapse:collapse;"><tr><td style="vertical-align:middle;width:150px;text-align:center;"><svg width="140" height="160" viewBox="0 0 150 170" xmlns="http://www.w3.org/2000/svg"><path d="M20 150 L55 45 Q75 32 95 45 L130 150 Z" fill="#C9B08E" stroke="#A88A64" stroke-width="2"/><path d="M17 150 L37 120 L113 120 L133 150 Z" fill="#3FC66B" opacity="0.88"/><path d="M37 120 L52 92 L98 92 L113 120 Z" fill="#FFCB2E" opacity="0.88"/><path d="M52 92 L64 66 L86 66 L98 92 Z" fill="#FF8A3D" opacity="0.88"/><path d="M64 66 L73 44 L77 44 L86 66 Z" fill="#FF5A6E" opacity="0.88"/><ellipse cx="75" cy="44" rx="16" ry="5" fill="#D43A2E"/><circle cx="65" cy="36" r="4" fill="#FF5A6E"/><circle cx="75" cy="28" r="5" fill="#FF5A6E"/><circle cx="85" cy="34" r="4" fill="#FF5A6E"/><circle cx="71" cy="24" r="3" fill="#FF5A6E"/><circle cx="81" cy="22" r="3" fill="#FF5A6E"/><circle cx="69" cy="32" r="2" fill="#FFCB2E"/><circle cx="79" cy="29" r="2.4" fill="#FFCB2E"/><circle cx="75" cy="20" r="2" fill="#FFCB2E"/></svg></td><td style="vertical-align:middle;padding-left:14px;"><div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;"><span style="display:inline-block;width:18px;height:18px;border-radius:5px;background:#FF5A6E;"></span><span style="font-size:15px;font-weight:800;color:#3A2C30;">4. 폭발!</span></div><div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;"><span style="display:inline-block;width:18px;height:18px;border-radius:5px;background:#FF8A3D;"></span><span style="font-size:15px;font-weight:800;color:#3A2C30;">3. 화가 나요</span></div><div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;"><span style="display:inline-block;width:18px;height:18px;border-radius:5px;background:#FFCB2E;"></span><span style="font-size:15px;font-weight:800;color:#3A2C30;">2. 조금 답답해요</span></div><div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;"><span style="display:inline-block;width:18px;height:18px;border-radius:5px;background:#3FC66B;"></span><span style="font-size:15px;font-weight:800;color:#3A2C30;">1. 괜찮아요</span></div></td></tr></table>`);
  }
  if (card.type === "pinwheel") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 0 440 380" xmlns="http://www.w3.org/2000/svg"><path d="M291 124 A74 74 0 0 1 262 166" stroke="#F5A0B1" stroke-width="3" fill="none" stroke-linecap="round" opacity="0.5"/><path d="M168 157 A74 74 0 0 1 146 111" stroke="#F5A0B1" stroke-width="3" fill="none" stroke-linecap="round" opacity="0.5"/><path d="M201 34 A74 74 0 0 1 251 38" stroke="#F5A0B1" stroke-width="3" fill="none" stroke-linecap="round" opacity="0.5"/><path d="M220 105 L261 64 A58 58 0 0 1 261 146 Z" fill="#FF9DBB" stroke="#fff" stroke-width="3"/><path d="M220 105 L261 146 A58 58 0 0 1 179 146 Z" fill="#8AC7FF" stroke="#fff" stroke-width="3"/><path d="M220 105 L179 146 A58 58 0 0 1 179 64 Z" fill="#FFD966" stroke="#fff" stroke-width="3"/><path d="M220 105 L179 64 A58 58 0 0 1 261 64 Z" fill="#7BE89B" stroke="#fff" stroke-width="3"/><circle cx="220" cy="105" r="11" fill="#9B6BFF" stroke="#fff" stroke-width="3"/><rect x="216" y="163" width="8" height="55" rx="4" fill="#B0784A"/><ellipse cx="95" cy="201" rx="22" ry="26" fill="#8AC7FF"/><circle cx="95" cy="163" r="22" fill="#F0B583"/><path d="M73 159 q22 -28 44 0 q-7 -18 -22 -18 q-15 0 -22 18 z" fill="#6B4A2A"/><circle cx="88" cy="161" r="2.8" fill="#333"/><circle cx="102" cy="161" r="2.8" fill="#333"/><ellipse cx="111" cy="171" rx="4.5" ry="6" fill="#C0392B"/><circle cx="121" cy="155" r="7" fill="#8AC7FF" opacity="0.5"/><circle cx="140" cy="137" r="9" fill="#8AC7FF" opacity="0.36"/><circle cx="161" cy="119" r="11" fill="#8AC7FF" opacity="0.24"/><text x="220" y="240" font-family="sans-serif" font-weight="800" font-size="15" fill="#D4728A" text-anchor="middle">숨 길이 게이지</text><rect x="40" y="250" width="66" height="36" rx="8" fill="#fff" stroke="#F5A0B1" stroke-width="2"/><text x="73" y="274" font-family="sans-serif" font-weight="900" font-size="17" fill="#F0C8D6" text-anchor="middle">1</text><rect x="112" y="250" width="66" height="36" rx="8" fill="#fff" stroke="#F5A0B1" stroke-width="2"/><text x="145" y="274" font-family="sans-serif" font-weight="900" font-size="17" fill="#F0C8D6" text-anchor="middle">2</text><rect x="184" y="250" width="66" height="36" rx="8" fill="#fff" stroke="#F5A0B1" stroke-width="2"/><text x="217" y="274" font-family="sans-serif" font-weight="900" font-size="17" fill="#F0C8D6" text-anchor="middle">3</text><rect x="256" y="250" width="66" height="36" rx="8" fill="#fff" stroke="#F5A0B1" stroke-width="2"/><text x="289" y="274" font-family="sans-serif" font-weight="900" font-size="17" fill="#F0C8D6" text-anchor="middle">4</text><rect x="328" y="250" width="66" height="36" rx="8" fill="#fff" stroke="#F5A0B1" stroke-width="2"/><text x="361" y="274" font-family="sans-serif" font-weight="900" font-size="17" fill="#F0C8D6" text-anchor="middle">5</text><text x="40" y="306" font-family="sans-serif" font-size="13" fill="#888">짧게</text><text x="400" y="306" font-family="sans-serif" font-size="13" fill="#888" text-anchor="end">아주 길게!</text></svg></div>`);
  }
  if (card.type === "distance") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 0 440 210" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="5" width="432" height="56" rx="14" fill="#fff" stroke="#FF5A6E" stroke-width="2.5"/><circle cx="40" cy="27" r="8" fill="#F0B583"/><rect x="33" y="35" width="14" height="18" rx="4" fill="#FF8AAB"/><circle cx="58" cy="27" r="8" fill="#F0B583"/><rect x="51" y="35" width="14" height="18" rx="4" fill="#8AC7FF"/><text x="428" y="29" font-family="sans-serif" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="end">너무 가까워요</text><text x="428" y="49" font-family="sans-serif" font-size="13" fill="#888" text-anchor="end">뒤로 한 걸음</text><rect x="4" y="71" width="432" height="56" rx="14" fill="#fff" stroke="#3FC66B" stroke-width="2.5"/><circle cx="40" cy="93" r="8" fill="#F0B583"/><rect x="33" y="101" width="14" height="18" rx="4" fill="#FF8AAB"/><circle cx="95" cy="93" r="8" fill="#F0B583"/><rect x="88" y="101" width="14" height="18" rx="4" fill="#8AC7FF"/><text x="428" y="95" font-family="sans-serif" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="end">딱 좋아요</text><text x="428" y="115" font-family="sans-serif" font-size="13" fill="#888" text-anchor="end">이 정도!</text><rect x="4" y="137" width="432" height="56" rx="14" fill="#fff" stroke="#3FA0FF" stroke-width="2.5"/><circle cx="40" cy="159" r="8" fill="#F0B583"/><rect x="33" y="167" width="14" height="18" rx="4" fill="#FF8AAB"/><circle cx="135" cy="159" r="8" fill="#F0B583"/><rect x="128" y="167" width="14" height="18" rx="4" fill="#8AC7FF"/><text x="428" y="161" font-family="sans-serif" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="end">너무 멀어요</text><text x="428" y="181" font-family="sans-serif" font-size="13" fill="#888" text-anchor="end">조금 가까이</text></svg></div>`);
  }
  if (card.type === "turntable") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 0 440 240" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="120" r="28" fill="#fff" stroke="#F5A0B1" stroke-width="3"/><path d="M150 98 l-9 18 h18 z" fill="#9B6BFF"/><circle cx="150" cy="50" r="22" fill="#fff" stroke="#FF9DBB" stroke-width="2.5"/><circle cx="150" cy="45" r="8" fill="#F0B583"/><rect x="141" y="53" width="18" height="13" rx="4" fill="#FF9DBB"/><rect x="128" y="74" width="44" height="17" rx="6" fill="#FF9DBB"/><text x="150" y="86" font-family="sans-serif" font-weight="800" font-size="12" fill="#fff" text-anchor="middle">민준</text><circle cx="235" cy="120" r="22" fill="#fff" stroke="#8AC7FF" stroke-width="2.5"/><circle cx="235" cy="115" r="8" fill="#F0B583"/><rect x="226" y="123" width="18" height="13" rx="4" fill="#8AC7FF"/><rect x="213" y="144" width="44" height="17" rx="6" fill="#8AC7FF"/><text x="235" y="156" font-family="sans-serif" font-weight="800" font-size="12" fill="#fff" text-anchor="middle">서연</text><circle cx="150" cy="190" r="22" fill="#fff" stroke="#7BE89B" stroke-width="2.5"/><circle cx="150" cy="185" r="8" fill="#F0B583"/><rect x="141" y="193" width="18" height="13" rx="4" fill="#7BE89B"/><rect x="128" y="214" width="44" height="17" rx="6" fill="#7BE89B"/><text x="150" y="226" font-family="sans-serif" font-weight="800" font-size="12" fill="#fff" text-anchor="middle">지호</text><circle cx="65" cy="120" r="22" fill="#fff" stroke="#FFD966" stroke-width="2.5"/><circle cx="65" cy="115" r="8" fill="#F0B583"/><rect x="56" y="123" width="18" height="13" rx="4" fill="#FFD966"/><rect x="43" y="144" width="44" height="17" rx="6" fill="#FFD966"/><text x="65" y="156" font-family="sans-serif" font-weight="800" font-size="12" fill="#fff" text-anchor="middle">하은</text><text x="300" y="105" font-family="sans-serif" font-weight="800" font-size="15" fill="#D4728A">화살표가</text><text x="300" y="127" font-family="sans-serif" font-weight="800" font-size="15" fill="#D4728A">가리키는</text><text x="300" y="149" font-family="sans-serif" font-weight="800" font-size="15" fill="#D4728A">사람 차례!</text></svg></div>`);
  }
  if (card.type === "syllable") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 236" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="48" cy="115" r="30" fill="#FF9DBB" filter="url(#sh)"/><ellipse cx="39" cy="105" rx="10" ry="6" fill="#fff" opacity="0.4"/><circle cx="48" cy="115" r="18" fill="#fff" opacity="0.55"/><circle cx="84.0" cy="115" r="3.5" fill="#F5A0B1"/><circle cx="120" cy="115" r="30" fill="#8AC7FF" filter="url(#sh)"/><ellipse cx="111" cy="105" rx="10" ry="6" fill="#fff" opacity="0.4"/><circle cx="120" cy="115" r="18" fill="#fff" opacity="0.55"/><circle cx="156.0" cy="115" r="3.5" fill="#F5A0B1"/><circle cx="192" cy="115" r="30" fill="#FFD966" filter="url(#sh)"/><ellipse cx="183" cy="105" rx="10" ry="6" fill="#fff" opacity="0.4"/><circle cx="192" cy="115" r="18" fill="#fff" opacity="0.55"/><circle cx="228.0" cy="115" r="3.5" fill="#F5A0B1"/><circle cx="264" cy="115" r="30" fill="#7BE89B" filter="url(#sh)"/><ellipse cx="255" cy="105" rx="10" ry="6" fill="#fff" opacity="0.4"/><circle cx="264" cy="115" r="18" fill="#fff" opacity="0.55"/><circle cx="300.0" cy="115" r="3.5" fill="#F5A0B1"/><circle cx="336" cy="115" r="30" fill="#C9AEFF" filter="url(#sh)"/><ellipse cx="327" cy="105" rx="10" ry="6" fill="#fff" opacity="0.4"/><circle cx="336" cy="115" r="18" fill="#fff" opacity="0.55"/><text x="220" y="180" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">빈 동그라미에 목표 단어를 한 글자씩 써넣으세요</text><text x="220" y="204" font-family="Noto Sans CJK KR" font-size="13" fill="#888" text-anchor="middle">하나씩 짚으며 또박또박 · 음절 추가 방지</text></svg></div>`);
  }
  if (card.type === "slidewindow") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 231" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="50" y="72" width="340" height="80" rx="16" fill="#fff" filter="url(#sh)"/><rect x="50" y="72" width="340" height="80" rx="16" fill="none" stroke="#F5A0B1" stroke-width="2.5"/><rect x="180" y="80" width="80" height="64" rx="10" fill="#FFF8E0" stroke="#FFCB2E" stroke-width="2.5"/><line x1="200" y1="112" x2="240" y2="112" stroke="#E0C068" stroke-width="1.5" stroke-dasharray="4 3"/><circle cx="115" cy="112" r="20" fill="#8AC7FF" filter="url(#sh)"/><path d="M120 104 l-9 8 9 8" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="325" cy="112" r="20" fill="#FF9DBB" filter="url(#sh)"/><path d="M320 104 l9 8 -9 8" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="220" y="180" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">창(노란 칸)에 글자를 써서 하나씩 밀어 보여줘요</text><text x="220" y="203" font-family="Noto Sans CJK KR" font-size="13" fill="#888" text-anchor="middle">한 글자씩 천천히 · 음절 늘리기/줄이기 연습</text></svg></div>`);
  }
  if (card.type === "mouthshape") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 286" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="75" cy="110" r="34" fill="#FFE0C4" filter="url(#sh)"/><circle cx="63" cy="100" r="3" fill="#5A4A3A"/><circle cx="87" cy="100" r="3" fill="#5A4A3A"/><ellipse cx="75" cy="120" rx="13" ry="16" fill="#C0392B"/><ellipse cx="75" cy="126" rx="7" ry="7" fill="#E88" opacity="0.7"/><text x="75" y="168" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#D4728A" text-anchor="middle">아</text><circle cx="185" cy="110" r="34" fill="#FFE0C4" filter="url(#sh)"/><circle cx="173" cy="100" r="3" fill="#5A4A3A"/><circle cx="197" cy="100" r="3" fill="#5A4A3A"/><path d="M170 120 q15 10 30 0 q-15 4 -30 0 z" fill="#C0392B"/><rect x="171" y="118" width="28" height="4" rx="2" fill="#fff"/><text x="185" y="168" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#D4728A" text-anchor="middle">이</text><circle cx="295" cy="110" r="34" fill="#FFE0C4" filter="url(#sh)"/><circle cx="283" cy="100" r="3" fill="#5A4A3A"/><circle cx="307" cy="100" r="3" fill="#5A4A3A"/><circle cx="295" cy="122" r="8" fill="#C0392B"/><circle cx="295" cy="122" r="4" fill="#E88" opacity="0.7"/><text x="295" y="168" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#D4728A" text-anchor="middle">우</text><circle cx="130" cy="210" r="34" fill="#FFE0C4" filter="url(#sh)"/><circle cx="118" cy="200" r="3" fill="#5A4A3A"/><circle cx="142" cy="200" r="3" fill="#5A4A3A"/><ellipse cx="130" cy="222" rx="10" ry="12" fill="#C0392B"/><ellipse cx="130" cy="224" rx="5" ry="6" fill="#E88" opacity="0.7"/><text x="130" y="268" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#D4728A" text-anchor="middle">오</text><circle cx="240" cy="210" r="34" fill="#FFE0C4" filter="url(#sh)"/><circle cx="228" cy="200" r="3" fill="#5A4A3A"/><circle cx="252" cy="200" r="3" fill="#5A4A3A"/><path d="M227 218 q13 12 26 0 q-13 3 -26 0 z" fill="#C0392B"/><text x="240" y="268" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#D4728A" text-anchor="middle">에</text><text x="360" y="215" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66">입 모양을</text><text x="360" y="235" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66">따라 해요</text></svg></div>`);
  }
  if (card.type === "pecs") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 236" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="75" cy="120" r="26" fill="#FF9DBB" filter="url(#sh)"/><circle cx="75" cy="114" r="11" fill="#F0B583"/><rect x="62" y="125" width="26" height="18" rx="6" fill="#fff" opacity="0.4"/><text x="75" y="172" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#D4728A" text-anchor="middle">아이</text><rect x="118" y="102" width="44" height="36" rx="6" fill="#fff" stroke="#F5A0B1" stroke-width="2.5" filter="url(#sh)"/><circle cx="140" cy="116" r="8" fill="#FF8A3D"/><rect x="130" y="126" width="20" height="4" rx="2" fill="#3FC66B"/><path d="M175 120 h55 M222 111 l10 9 -10 9" stroke="#3FC66B" stroke-width="4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="202" y="100" font-family="Noto Sans CJK KR" font-weight="700" font-size="12" fill="#3FC66B" text-anchor="middle">건네요</text><circle cx="310" cy="120" r="30" fill="#8AC7FF" filter="url(#sh)"/><circle cx="310" cy="112" r="13" fill="#F0B583"/><rect x="295" y="125" width="30" height="20" rx="6" fill="#fff" opacity="0.4"/><text x="310" y="176" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#D4728A" text-anchor="middle">선생님</text><text x="220" y="180" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#D4728A" text-anchor="middle">그림카드를 건네면 → 원하는 것을 받아요</text><text x="220" y="204" font-family="Noto Sans CJK KR" font-size="13" fill="#888" text-anchor="middle">말 대신 그림으로 요청하기 (PECS 1단계)</text></svg></div>`);
  }
  if (card.type === "callcard") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 236" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="95" cy="115" r="34" fill="#FF9DBB" filter="url(#sh)"/><circle cx="95" cy="104" r="15" fill="#F0B583"/><path d="M80 120 q15 -14 30 0 z" fill="#fff" opacity="0.5"/><rect x="66" y="160" width="58" height="26" rx="9" fill="#FF9DBB"/><text x="95" y="178" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#fff" text-anchor="middle">○○</text><path d="M150 115 h70 M212 106 l12 9 -12 9" stroke="#3FC66B" stroke-width="4.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="245" y="92" width="150" height="46" rx="16" fill="#3FC66B" filter="url(#sh)"/><text x="320" y="121" font-family="Noto Sans CJK KR" font-weight="800" font-size="19" fill="#fff" text-anchor="middle">오세요</text><text x="220" y="205" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">○○ 칸에 부를 사람(엄마·선생님)을 넣어 쓰세요</text></svg></div>`);
  }
  if (card.type === "naming") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 261" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="40" y="70" width="150" height="120" rx="16" fill="#fff" stroke="#F5A0B1" stroke-width="2.5" stroke-dasharray="7 5" filter="url(#sh)"/><text x="115" y="140" font-family="Noto Sans CJK KR" font-weight="900" font-size="40" fill="#F0C8D6" text-anchor="middle">?</text><text x="115" y="205" font-family="Noto Sans CJK KR" font-size="12.5" fill="#888" text-anchor="middle">사진·그림 붙이는 칸</text><path d="M205 130 h40 M238 121 l10 9 -10 9" stroke="#3FC66B" stroke-width="4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="260" y="95" width="150" height="70" rx="18" fill="#3FC66B" filter="url(#sh)"/><path d="M260 130 l-9 -5 v10 z" fill="#3FC66B"/><text x="335" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="17" fill="#fff" text-anchor="middle">"○○예요"</text><text x="335" y="150" font-family="Noto Sans CJK KR" font-size="12" fill="#fff" text-anchor="middle" opacity="0.9">이름 말하기</text><text x="220" y="230" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#D4728A" text-anchor="middle">"이게 뭐예요?" → 사물 이름을 말해요 (명명하기)</text></svg></div>`);
  }
  if (card.type === "corevocab") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 266" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="3" y="52" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="58" cy="82" r="20" fill="#3FC66B"/><path d="M58 71 v22 M47 82 h22" stroke="#fff" stroke-width="4" stroke-linecap="round"/><text x="58" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">더</text><rect x="128" y="52" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="183" cy="82" r="20" fill="#FF8A3D"/><path d="M183 90 C174 83 174 74 180 74 C183 74 183 78 183 79 C183 78 183 74 186 74 C192 74 192 83 183 90 Z" fill="#fff"/><text x="183" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">주세요</text><rect x="253" y="52" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="308" cy="82" r="20" fill="#FF5A6E"/><rect x="297" y="80" width="22" height="5" rx="2.5" fill="#fff"/><text x="308" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">그만</text><rect x="3" y="157" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="58" cy="187" r="20" fill="#FF9DBB"/><text x="58" y="193" font-family="Noto Sans CJK KR" font-weight="900" font-size="16" fill="#fff" text-anchor="middle">!</text><text x="58" y="233" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">도와줘</text><rect x="128" y="157" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="183" cy="187" r="20" fill="#3FA0FF"/><path d="M174 187 l6 6 11-12" stroke="#fff" stroke-width="4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="183" y="233" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">네</text><rect x="253" y="157" width="110" height="90" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="308" cy="187" r="20" fill="#9B6BFF"/><path d="M300 179 l16 16 M316 179 l-16 16" stroke="#fff" stroke-width="4" stroke-linecap="round"/><text x="308" y="233" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30" text-anchor="middle">아니요</text></svg></div>`);
  }
  if (card.type === "sentence") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 316" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="18" y="62" width="56" height="40" rx="10" fill="#D4728A"/><text x="46" y="87" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#fff" text-anchor="middle">1어절</text><rect x="90" y="60" width="80" height="44" rx="12" fill="#fff" stroke="#FF9DBB" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="130" y="88" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><rect x="18" y="132" width="56" height="40" rx="10" fill="#D4728A"/><text x="46" y="157" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#fff" text-anchor="middle">2어절</text><rect x="90" y="130" width="80" height="44" rx="12" fill="#fff" stroke="#FF9DBB" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="130" y="158" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><text x="174" y="158" font-family="Noto Sans CJK KR" font-weight="900" font-size="18" fill="#F5A0B1">+</text><rect x="194" y="130" width="80" height="44" rx="12" fill="#fff" stroke="#8AC7FF" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="234" y="158" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><rect x="18" y="202" width="56" height="40" rx="10" fill="#D4728A"/><text x="46" y="227" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#fff" text-anchor="middle">3어절</text><rect x="90" y="200" width="80" height="44" rx="12" fill="#fff" stroke="#FF9DBB" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="130" y="228" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><text x="174" y="228" font-family="Noto Sans CJK KR" font-weight="900" font-size="18" fill="#F5A0B1">+</text><rect x="194" y="200" width="80" height="44" rx="12" fill="#fff" stroke="#8AC7FF" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="234" y="228" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><text x="278" y="228" font-family="Noto Sans CJK KR" font-weight="900" font-size="18" fill="#F5A0B1">+</text><rect x="298" y="200" width="80" height="44" rx="12" fill="#fff" stroke="#FFD966" stroke-width="2.5" stroke-dasharray="6 4" filter="url(#sh)"/><text x="338" y="228" font-family="Noto Sans CJK KR" font-weight="900" font-size="20" fill="#F0DDE6" text-anchor="middle">___</text><text x="220" y="285" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">빈 칸에 단어를 채워 점점 길게 (예: 공 → 공 주세요 → 빨간 공 주세요)</text></svg></div>`);
  }
  if (card.type === "relay") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 321" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="44" cy="80" r="20" fill="#FF9DBB" filter="url(#sh)"/><circle cx="44" cy="76" r="9" fill="#F0B583"/><path d="M33 95 q11 -12 22 0 z" fill="#fff" opacity="0.55"/><rect x="74" y="62" width="150" height="36" rx="18" fill="#FF9DBB" filter="url(#sh)"/><path d="M74 80 l-8 -4 v8 z" fill="#FF9DBB"/><circle cx="396" cy="135" r="20" fill="#8AC7FF" filter="url(#sh)"/><circle cx="396" cy="131" r="9" fill="#F0B583"/><path d="M385 150 q11 -12 22 0 z" fill="#fff" opacity="0.55"/><rect x="216" y="117" width="150" height="36" rx="18" fill="#8AC7FF" filter="url(#sh)"/><path d="M366 135 l8 -4 v8 z" fill="#8AC7FF"/><circle cx="44" cy="190" r="20" fill="#FF9DBB" filter="url(#sh)"/><circle cx="44" cy="186" r="9" fill="#F0B583"/><path d="M33 205 q11 -12 22 0 z" fill="#fff" opacity="0.55"/><rect x="74" y="172" width="150" height="36" rx="18" fill="#FF9DBB" filter="url(#sh)"/><path d="M74 190 l-8 -4 v8 z" fill="#FF9DBB"/><circle cx="396" cy="245" r="20" fill="#8AC7FF" filter="url(#sh)"/><circle cx="396" cy="241" r="9" fill="#F0B583"/><path d="M385 260 q11 -12 22 0 z" fill="#fff" opacity="0.55"/><rect x="216" y="227" width="150" height="36" rx="18" fill="#8AC7FF" filter="url(#sh)"/><path d="M366 245 l8 -4 v8 z" fill="#8AC7FF"/><path d="M220 107 q0 6 0 12" stroke="#F5A0B1" stroke-width="2.5" fill="none" marker-end=""/><circle cx="220" cy="121" r="2.5" fill="#F5A0B1"/><path d="M220 162 q0 6 0 12" stroke="#F5A0B1" stroke-width="2.5" fill="none" marker-end=""/><circle cx="220" cy="176" r="2.5" fill="#F5A0B1"/><path d="M220 217 q0 6 0 12" stroke="#F5A0B1" stroke-width="2.5" fill="none" marker-end=""/><circle cx="220" cy="231" r="2.5" fill="#F5A0B1"/><text x="220" y="290" font-family="Noto Sans CJK KR" font-weight="800" font-size="13.5" fill="#D4728A" text-anchor="middle">내 차례 → 친구 차례, 한 번씩 주고받아요</text></svg></div>`);
  }
  if (card.type === "bodysignal") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 296" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="20" y="52" width="195" height="98" rx="16" fill="#fff" filter="url(#sh)"/><rect x="20" y="52" width="195" height="98" rx="16" fill="none" stroke="#F5A0B1" stroke-width="2"/><path d="M44 90 q24 -12 48 0 q-3 15 -24 15 q-21 0 -24 -15 z" fill="#FF8A3D"/><ellipse cx="68" cy="90" rx="24" ry="5" fill="#FFB37A"/><rect x="42" y="103" width="52" height="5" rx="2.5" fill="#E0752E"/><text x="110" y="92" font-family="Noto Sans CJK KR" font-weight="800" font-size="18" fill="#D4728A">배고파요</text><text x="110" y="114" font-family="Noto Sans CJK KR" font-size="12" fill="#888">배가 꼬르륵</text><rect x="225" y="52" width="195" height="98" rx="16" fill="#fff" filter="url(#sh)"/><rect x="225" y="52" width="195" height="98" rx="16" fill="none" stroke="#F5A0B1" stroke-width="2"/><path d="M259 74 h28 l-4 40 h-20 z" fill="#fff" stroke="#2ED4C4" stroke-width="2.5"/><path d="M262 94 h22 l-2.5 18 h-17 z" fill="#2ED4C4" opacity="0.6"/><path d="M273 66 q3 3 0 6 q-3 -3 0 -6" fill="#2ED4C4"/><text x="315" y="92" font-family="Noto Sans CJK KR" font-weight="800" font-size="18" fill="#D4728A">목말라요</text><text x="315" y="114" font-family="Noto Sans CJK KR" font-size="12" fill="#888">입이 말라요</text><rect x="20" y="160" width="195" height="98" rx="16" fill="#fff" filter="url(#sh)"/><rect x="20" y="160" width="195" height="98" rx="16" fill="none" stroke="#F5A0B1" stroke-width="2"/><circle cx="68" cy="200" r="22" fill="#9B6BFF"/><ellipse cx="61" cy="193" rx="7" ry="4" fill="#fff" opacity="0.35"/><path d="M55 197 q5 5 10 0 M71 197 q5 5 10 0" stroke="#fff" stroke-width="2.4" fill="none" stroke-linecap="round"/><text x="82" y="188" font-family="Noto Sans CJK KR" font-weight="900" font-size="13" fill="#fff">z</text><text x="110" y="200" font-family="Noto Sans CJK KR" font-weight="800" font-size="18" fill="#D4728A">피곤해요</text><text x="110" y="222" font-family="Noto Sans CJK KR" font-size="12" fill="#888">눈이 무거워요</text><rect x="225" y="160" width="195" height="98" rx="16" fill="#fff" filter="url(#sh)"/><rect x="225" y="160" width="195" height="98" rx="16" fill="none" stroke="#F5A0B1" stroke-width="2"/><circle cx="273" cy="200" r="15" fill="#FFCB2E"/><line x1="292" y1="200" x2="298" y2="200" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="286" y1="213" x2="291" y2="218" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="273" y1="219" x2="273" y2="225" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="260" y1="213" x2="255" y2="218" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="254" y1="200" x2="248" y2="200" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="260" y1="187" x2="255" y2="182" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="273" y1="181" x2="273" y2="175" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><line x1="286" y1="187" x2="291" y2="182" stroke="#FF8A3D" stroke-width="2.6" stroke-linecap="round"/><path d="M293 208 q3 4 0 7 q-3 -3 0 -7" fill="#3FA0FF"/><text x="315" y="200" font-family="Noto Sans CJK KR" font-weight="800" font-size="18" fill="#D4728A">더워요</text><text x="315" y="222" font-family="Noto Sans CJK KR" font-size="12" fill="#888">땀이 나요</text></svg></div>`);
  }
  if (card.type === "receptive") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 266" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="3" y="55" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="58" cy="77" r="8" fill="#F0B583"/><path d="M49 87 v10 h4 v-8 M67 87 v10 h-4" fill="none" stroke="#FF9DBB" stroke-width="5" stroke-linecap="round"/><rect x="56" y="85" width="5" height="14" fill="#FF9DBB"/><rect x="47" y="99" width="22" height="4" rx="2" fill="#B0784A"/><text x="58" y="135" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">앉아요</text><rect x="128" y="55" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="183" cy="75" r="8" fill="#F0B583"/><rect x="178" y="84" width="10" height="16" rx="4" fill="#FF9DBB"/><path d="M180 100 v6 M186 100 v6" stroke="#F0B583" stroke-width="4" stroke-linecap="round"/><path d="M183 67 v4" stroke="#3FC66B" stroke-width="3" stroke-linecap="round"/><path d="M180 69 l3 -3 3 3" fill="none" stroke="#3FC66B" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><text x="183" y="135" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">일어서요</text><rect x="253" y="55" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="308" cy="78" r="8" fill="#F0B583"/><path d="M305 89 v14 M311 89 v14" stroke="#FF9DBB" stroke-width="5" stroke-linecap="round"/><path d="M295 93 l8 4 M321 93 l-8 4" stroke="#F0B583" stroke-width="5" stroke-linecap="round"/><path d="M292 87 q-3 3 0 6 M324 87 q3 3 0 6" stroke="#FFCB2E" stroke-width="2" fill="none"/><text x="308" y="135" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">박수 쳐요</text><rect x="3" y="160" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="58" cy="183" r="8" fill="#F0B583"/><rect x="52" y="192" width="12" height="13" rx="4" fill="#FF9DBB"/><rect x="62" y="194" width="14" height="10" rx="3" fill="#FFCB2E"/><text x="58" y="240" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">주세요</text><rect x="128" y="160" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="183" cy="183" r="8" fill="#F0B583"/><rect x="177" y="192" width="12" height="14" rx="4" fill="#FF9DBB"/><path d="M189 196 l10 -6" stroke="#F0B583" stroke-width="5" stroke-linecap="round"/><circle cx="201" cy="188" r="3.5" fill="#FF5A6E"/><text x="183" y="240" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">만져요</text><rect x="253" y="160" width="110" height="92" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="308" cy="183" r="8" fill="#F0B583"/><rect x="302" y="192" width="12" height="14" rx="4" fill="#FF9DBB"/><path d="M314 196 q10 -2 8 6" fill="none" stroke="#F0B583" stroke-width="5" stroke-linecap="round"/><text x="308" y="240" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#3A2C30" text-anchor="middle">이리 와요</text></svg></div>`);
  }
  if (card.type === "bodyparts") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 326" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><path d="M138 150 q0 -88 82 -88 q82 0 82 88 q-22 -42 -82 -42 q-60 0 -82 42 z" fill="#6B4A2A"/><circle cx="220" cy="175" r="80" fill="#FFE0C4" filter="url(#sh)"/><circle cx="140" cy="175" r="14" fill="#FFE0C4"/><circle cx="300" cy="175" r="14" fill="#FFE0C4"/><ellipse cx="192" cy="159" rx="13" ry="10" fill="#fff"/><circle cx="192" cy="159" r="5.5" fill="#3A2C30"/><ellipse cx="248" cy="159" rx="13" ry="10" fill="#fff"/><circle cx="248" cy="159" r="5.5" fill="#3A2C30"/><path d="M220 169 q-7 14 0 18 q7 -4 0 -18" fill="#F0B583"/><path d="M196 209 q24 18 48 0" fill="none" stroke="#C0392B" stroke-width="4" stroke-linecap="round"/><line x1="179" y1="159" x2="125" y2="159" stroke="#FF5A6E" stroke-width="2"/><rect x="78" y="144" width="48" height="30" rx="15" fill="#FF5A6E" filter="url(#sh)"/><text x="102" y="165" font-family="Noto Sans CJK KR" font-weight="900" font-size="15" fill="#fff" text-anchor="middle">눈</text><line x1="314" y1="175" x2="340" y2="175" stroke="#9B6BFF" stroke-width="2"/><rect x="339" y="160" width="48" height="30" rx="15" fill="#9B6BFF" filter="url(#sh)"/><text x="363" y="181" font-family="Noto Sans CJK KR" font-weight="900" font-size="15" fill="#fff" text-anchor="middle">귀</text><line x1="220" y1="183" x2="150" y2="215" stroke="#3FA0FF" stroke-width="2"/><rect x="101" y="205" width="48" height="30" rx="15" fill="#3FA0FF" filter="url(#sh)"/><text x="125" y="226" font-family="Noto Sans CJK KR" font-weight="900" font-size="15" fill="#fff" text-anchor="middle">코</text><line x1="220" y1="215" x2="290" y2="225" stroke="#3FC66B" stroke-width="2"/><rect x="291" y="215" width="48" height="30" rx="15" fill="#3FC66B" filter="url(#sh)"/><text x="315" y="236" font-family="Noto Sans CJK KR" font-weight="900" font-size="15" fill="#fff" text-anchor="middle">입</text><text x="220" y="295" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">"눈 어디 있어요?" 물으면 짚어요 (신체 부위)</text></svg></div>`);
  }
  if (card.type === "jointattn") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 316" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="80" cy="140" r="30" fill="#8AC7FF" filter="url(#sh)"/><circle cx="80" cy="130" r="13" fill="#F0B583"/><text x="80" y="192" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#D4728A" text-anchor="middle">선생님</text><path d="M95 136 l45 -30" stroke="#F0B583" stroke-width="7" stroke-linecap="round"/><circle cx="142" cy="104" r="5" fill="#F0B583"/><path d="M150 100 L320 75" stroke="#3FC66B" stroke-width="2.5" stroke-dasharray="7 5" fill="none"/><circle cx="340" cy="80" r="26" fill="#FFCB2E" filter="url(#sh)"/><path d="M340 62 l5 12 13 1 -10 9 3 13 -11 -7 -11 7 3 -13 -10 -9 13 -1 z" fill="#fff"/><text x="340" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#D4728A" text-anchor="middle">저기!</text><circle cx="180" cy="210" r="24" fill="#FF9DBB" filter="url(#sh)"/><circle cx="180" cy="202" r="11" fill="#F0B583"/><circle cx="176" cy="201" r="2.5" fill="#333"/><circle cx="184" cy="201" r="2.5" fill="#333"/><text x="180" y="252" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#D4728A" text-anchor="middle">아이도 봐요</text><path d="M188 201 L316 90" stroke="#F5A0B1" stroke-width="2" stroke-dasharray="5 4" fill="none"/><text x="220" y="285" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">"저기 봐!" 가리키는 곳을 함께 봐요 (공동주의)</text></svg></div>`);
  }
  if (card.type === "eyecontact") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 291" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="115" cy="150" r="52" fill="#DCEBF8" filter="url(#sh)"/><circle cx="115" cy="150" r="52" fill="none" stroke="#8AC7FF" stroke-width="3"/><circle cx="133" cy="142" r="11" fill="#fff"/><circle cx="139" cy="142" r="6" fill="#3A2C30"/><circle cx="109" cy="142" r="11" fill="#fff"/><circle cx="115" cy="142" r="6" fill="#3A2C30"/><path d="M105 168 q22 12 40 0" fill="none" stroke="#8A6A6A" stroke-width="3" stroke-linecap="round"/><text x="115" y="230" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">선생님</text><circle cx="325" cy="150" r="52" fill="#FBDCE4" filter="url(#sh)"/><circle cx="325" cy="150" r="52" fill="none" stroke="#FF9DBB" stroke-width="3"/><circle cx="307" cy="142" r="11" fill="#fff"/><circle cx="301" cy="142" r="6" fill="#3A2C30"/><circle cx="331" cy="142" r="11" fill="#fff"/><circle cx="325" cy="142" r="6" fill="#3A2C30"/><path d="M315 168 q22 12 40 0" fill="none" stroke="#8A6A6A" stroke-width="3" stroke-linecap="round"/><text x="325" y="230" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#D4728A" text-anchor="middle">아이</text><path d="M145 142 L295 142" stroke="#3FC66B" stroke-width="3" stroke-dasharray="7 5"/><circle cx="220" cy="142" r="15" fill="#3FC66B"/><path d="M214 142 l4 4 8 -8" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="220" y="255" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#D4728A" text-anchor="middle">"나 봐!" 눈을 마주 봐요 (눈맞춤)</text></svg></div>`);
  }
  if (card.type === "imitate") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 306" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><text x="35" y="88" font-family="Noto Sans CJK KR" font-weight="700" font-size="12" fill="#5B8BB5">선생님</text><circle cx="90" cy="95" r="28" fill="#8AC7FF" filter="url(#sh)"/><circle cx="90" cy="89" r="12" fill="#F0B583"/><rect x="85" y="99" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M84 101 L70 79" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><path d="M96 101 L110 79" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><circle cx="69" cy="77" r="4" fill="#F0B583"/><circle cx="111" cy="77" r="4" fill="#F0B583"/><path d="M90 130 v22 M84 144 l6 8 6 -8" stroke="#3FC66B" stroke-width="3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="35" y="188" font-family="Noto Sans CJK KR" font-weight="700" font-size="12" fill="#D4728A">아이</text><circle cx="90" cy="190" r="28" fill="#FF9DBB" filter="url(#sh)"/><circle cx="90" cy="184" r="12" fill="#F0B583"/><rect x="85" y="194" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M84 196 L70 174" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><path d="M96 196 L110 174" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><circle cx="69" cy="172" r="4" fill="#F0B583"/><circle cx="111" cy="172" r="4" fill="#F0B583"/><text x="90" y="238" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#3A2C30" text-anchor="middle">만세!</text><circle cx="220" cy="95" r="28" fill="#8AC7FF" filter="url(#sh)"/><circle cx="220" cy="89" r="12" fill="#F0B583"/><rect x="215" y="99" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M214 99 q-14 -4 -6 -14" stroke="#F0B583" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M226 99 q14 -4 6 -14" stroke="#F0B583" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M220 130 v22 M214 144 l6 8 6 -8" stroke="#3FC66B" stroke-width="3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="220" cy="190" r="28" fill="#FF9DBB" filter="url(#sh)"/><circle cx="220" cy="184" r="12" fill="#F0B583"/><rect x="215" y="194" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M214 194 q-14 -4 -6 -14" stroke="#F0B583" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M226 194 q14 -4 6 -14" stroke="#F0B583" stroke-width="6" fill="none" stroke-linecap="round"/><text x="220" y="238" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#3A2C30" text-anchor="middle">머리 짚기</text><circle cx="350" cy="95" r="28" fill="#8AC7FF" filter="url(#sh)"/><circle cx="350" cy="89" r="12" fill="#F0B583"/><rect x="345" y="99" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M344 103 L328 103" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><path d="M356 103 L372 103" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><circle cx="327" cy="103" r="4" fill="#F0B583"/><circle cx="373" cy="103" r="4" fill="#F0B583"/><path d="M350 130 v22 M344 144 l6 8 6 -8" stroke="#3FC66B" stroke-width="3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="350" cy="190" r="28" fill="#FF9DBB" filter="url(#sh)"/><circle cx="350" cy="184" r="12" fill="#F0B583"/><rect x="345" y="194" width="10" height="16" rx="4" fill="#fff" opacity="0.5"/><path d="M344 198 L328 198" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><path d="M356 198 L372 198" stroke="#F0B583" stroke-width="6" stroke-linecap="round"/><circle cx="327" cy="198" r="4" fill="#F0B583"/><circle cx="373" cy="198" r="4" fill="#F0B583"/><text x="350" y="238" font-family="Noto Sans CJK KR" font-weight="800" font-size="14" fill="#3A2C30" text-anchor="middle">팔 벌려</text><text x="220" y="272" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">"나처럼 해봐" 선생님 동작을 똑같이 (동작 모방)</text></svg></div>`);
  }
  if (card.type === "animalsound") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 286" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="25" y="52" width="195" height="98" rx="16" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="67" cy="100" r="26" fill="#C68A52"/><ellipse cx="45" cy="86" rx="9" ry="14" fill="#8A5A2A" transform="rotate(-20 45 86)"/><ellipse cx="89" cy="86" rx="9" ry="14" fill="#8A5A2A" transform="rotate(20 89 86)"/><circle cx="58" cy="96" r="3.5" fill="#000"/><circle cx="76" cy="96" r="3.5" fill="#000"/><ellipse cx="67" cy="108" rx="6" ry="4.5" fill="#000"/><text x="120" y="92" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30">강아지</text><rect x="115" y="104" width="88" height="30" rx="15" fill="#FF9DBB"/><text x="159" y="124" font-family="Noto Sans CJK KR" font-weight="900" font-size="16" fill="#fff" text-anchor="middle">멍멍</text><rect x="230" y="52" width="195" height="98" rx="16" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="272" cy="100" r="26" fill="#FFCB2E"/><path d="M248 78 l6 16 -14 -4 z" fill="#FFCB2E"/><path d="M296 78 l-6 16 14 -4 z" fill="#FFCB2E"/><path d="M258 94 l7 3 M286 94 l-7 3" stroke="#000" stroke-width="2" stroke-linecap="round"/><circle cx="263" cy="98" r="3" fill="#000"/><circle cx="281" cy="98" r="3" fill="#000"/><path d="M272 106 l-3 3 3 2 3 -2 z" fill="#E88"/><text x="325" y="92" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30">고양이</text><rect x="320" y="104" width="88" height="30" rx="15" fill="#FF9DBB"/><text x="364" y="124" font-family="Noto Sans CJK KR" font-weight="900" font-size="16" fill="#fff" text-anchor="middle">야옹</text><rect x="25" y="160" width="195" height="98" rx="16" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><ellipse cx="67" cy="208" rx="27" ry="24" fill="#fff" stroke="#C9B08E" stroke-width="2"/><ellipse cx="55" cy="198" rx="8" ry="6" fill="#5A4A3A"/><ellipse cx="81" cy="214" rx="7" ry="5" fill="#5A4A3A"/><circle cx="58" cy="206" r="3.5" fill="#000"/><circle cx="76" cy="206" r="3.5" fill="#000"/><ellipse cx="67" cy="220" rx="12" ry="8" fill="#F0B0B8"/><circle cx="63" cy="220" r="2" fill="#000"/><circle cx="71" cy="220" r="2" fill="#000"/><text x="120" y="200" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30">소</text><rect x="115" y="212" width="88" height="30" rx="15" fill="#FF9DBB"/><text x="159" y="232" font-family="Noto Sans CJK KR" font-weight="900" font-size="16" fill="#fff" text-anchor="middle">음메</text><rect x="230" y="160" width="195" height="98" rx="16" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="272" cy="208" r="26" fill="#FFD966"/><circle cx="274" cy="204" r="3.5" fill="#000"/><path d="M268 216 q-14 0 -14 6 q0 4 14 2 q10 -2 0 -8" fill="#FF8A3D"/><text x="325" y="200" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#3A2C30">오리</text><rect x="320" y="212" width="88" height="30" rx="15" fill="#FF9DBB"/><text x="364" y="232" font-family="Noto Sans CJK KR" font-weight="900" font-size="16" fill="#fff" text-anchor="middle">꽥꽥</text></svg></div>`);
  }
  if (card.type === "opposite") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 346" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><rect x="20" y="52" width="400" height="82" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="80" cy="93" r="30" fill="#FF8A3D"/><text x="80" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">커요</text><text x="180" y="100" font-family="Noto Sans CJK KR" font-weight="900" font-size="24" fill="#F5A0B1" text-anchor="middle">↔</text><circle cx="290" cy="93" r="13" fill="#FF8A3D"/><text x="290" y="128" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">작아요</text><rect x="20" y="144" width="400" height="82" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="50" cy="175" r="9" fill="#3FC66B"/><circle cx="72" cy="175" r="9" fill="#3FC66B"/><circle cx="94" cy="175" r="9" fill="#3FC66B"/><circle cx="50" cy="197" r="9" fill="#3FC66B"/><circle cx="72" cy="197" r="9" fill="#3FC66B"/><circle cx="94" cy="197" r="9" fill="#3FC66B"/><text x="80" y="220" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">많아요</text><text x="180" y="192" font-family="Noto Sans CJK KR" font-weight="900" font-size="24" fill="#F5A0B1" text-anchor="middle">↔</text><circle cx="285" cy="185" r="9" fill="#3FC66B"/><circle cx="300" cy="185" r="9" fill="#3FC66B"/><text x="290" y="220" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">적어요</text><rect x="20" y="236" width="400" height="82" rx="14" fill="#fff" stroke="#F5A0B1" stroke-width="2" filter="url(#sh)"/><circle cx="60" cy="277" r="15" fill="#9B6BFF"/><circle cx="100" cy="277" r="15" fill="#9B6BFF"/><text x="80" y="312" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">같아요</text><text x="180" y="284" font-family="Noto Sans CJK KR" font-weight="900" font-size="24" fill="#F5A0B1" text-anchor="middle">↔</text><circle cx="270" cy="277" r="15" fill="#9B6BFF"/><rect x="290" y="262" width="30" height="30" rx="4" fill="#FFCB2E"/><text x="295" y="312" font-family="Noto Sans CJK KR" font-weight="800" font-size="16" fill="#D4728A" text-anchor="middle">달라요</text></svg></div>`);
  }
  if (card.type === "sorting") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 326" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><text x="20" y="70" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#D4728A">색깔 맞추기</text><circle cx="40" cy="105" r="24" fill="#FF5A6E" filter="url(#sh)"/><text x="40" y="145" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">빨강</text><circle cx="140" cy="105" r="24" fill="#3FA0FF" filter="url(#sh)"/><text x="140" y="145" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">파랑</text><circle cx="240" cy="105" r="24" fill="#FFCB2E" filter="url(#sh)"/><text x="240" y="145" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">노랑</text><circle cx="340" cy="105" r="24" fill="#3FC66B" filter="url(#sh)"/><text x="340" y="145" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">초록</text><text x="20" y="185" font-family="Noto Sans CJK KR" font-weight="800" font-size="15" fill="#D4728A">모양 맞추기</text><circle cx="60" cy="220" r="24" fill="#FF9DBB" filter="url(#sh)"/><text x="60" y="262" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">동그라미</text><rect x="136" y="196" width="48" height="48" rx="6" fill="#8AC7FF" filter="url(#sh)"/><text x="160" y="262" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">네모</text><path d="M260 196 l24 48 -48 0 z" fill="#FFCB2E" filter="url(#sh)"/><text x="260" y="262" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">세모</text><path d="M360 196 l7 16 17 1 -13 11 4 17 -15 -9 -15 9 4 -17 -13 -11 17 -1 z" fill="#3FC66B" filter="url(#sh)"/><text x="360" y="262" font-family="Noto Sans CJK KR" font-weight="800" font-size="13" fill="#3A2C30" text-anchor="middle">별</text><text x="220" y="295" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">같은 색·같은 모양끼리 모아요 (분류)</text></svg></div>`);
  }
  if (card.type === "counting") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 351" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="55" cy="80" r="22" fill="#FF9DBB" filter="url(#sh)"/><text x="55" y="88" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">1</text><circle cx="100" cy="80" r="13" fill="#FF5A6E"/><circle cx="55" cy="128" r="22" fill="#8AC7FF" filter="url(#sh)"/><text x="55" y="136" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">2</text><circle cx="100" cy="128" r="13" fill="#3FA0FF"/><circle cx="138" cy="128" r="13" fill="#3FA0FF"/><circle cx="55" cy="176" r="22" fill="#FFD966" filter="url(#sh)"/><text x="55" y="184" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">3</text><circle cx="100" cy="176" r="13" fill="#E0A800"/><circle cx="138" cy="176" r="13" fill="#E0A800"/><circle cx="176" cy="176" r="13" fill="#E0A800"/><circle cx="55" cy="224" r="22" fill="#7BE89B" filter="url(#sh)"/><text x="55" y="232" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">4</text><circle cx="100" cy="224" r="13" fill="#3FC66B"/><circle cx="138" cy="224" r="13" fill="#3FC66B"/><circle cx="176" cy="224" r="13" fill="#3FC66B"/><circle cx="214" cy="224" r="13" fill="#3FC66B"/><circle cx="55" cy="272" r="22" fill="#C9AEFF" filter="url(#sh)"/><text x="55" y="280" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">5</text><circle cx="100" cy="272" r="13" fill="#9B6BFF"/><circle cx="138" cy="272" r="13" fill="#9B6BFF"/><circle cx="176" cy="272" r="13" fill="#9B6BFF"/><circle cx="214" cy="272" r="13" fill="#9B6BFF"/><circle cx="252" cy="272" r="13" fill="#9B6BFF"/><text x="220" y="322" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">숫자만큼 하나씩 세어요 (1·2·3·4·5)</text></svg></div>`);
  }
...
function getVisualCards(func) {
  ...
  const sets = {
    escape: [
      ...
      { type: "mouthshape", title: "입 모양 따라 하기 (아·이·우·오·에)" },
    ...
    attention: [
      ...
      { type: "animalsound", title: "동물 소리 따라 하기 (소리 모방)" },
      ...
      { type: "naming", title: "뭐예요? 이름 말하기 (명명)" },
      { type: "syllable", title: "또박또박 말해요 (음절 도트·빈칸)" },
      { type: "slidewindow", title: "한 글자씩 창문 (슬라이드·빈칸)" },
      { type: "mouthshape", title: "입 모양 따라 하기 (아·이·우·오·에)" },
      { type: "sentence", title: "문장 늘리기 (한 마디→여러 마디)" },
...
function VisualCard({ card, slotEditable, onSlotPhoto }) {
        ...
        <div>
          <div style={{ display:"flex", alignItems:"center", gap:12, background:"#fff", border:"2px solid #2ED4C4", borderRadius:14, padding:"8px 12px", marginBottom:6 }}>
            ...
            <div style={{ marginLeft:4 }}>
              ...
              <div style={{ fontSize:12.5, color:"#888" }}>입 다물기</div>
            </div>
          </div>
    ...
    return (
      <CardFrame title={card.title}>
        <div style={{ display:"flex", alignItems:"center", gap:14 }}>
          <div style={{ flexShrink:0 }} dangerouslySetInnerHTML={{ __html: "<svg width=\"140\" height=\"160\" viewBox=\"0 0 150 170\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M20 150 L55 45 Q75 32 95 45 L130 150 Z\" fill=\"#C9B08E\" stroke=\"#A88A64\" stroke-width=\"2\"/><path d=\"M17 150 L37 120 L113 120 L133 150 Z\" fill=\"#3FC66B\" opacity=\"0.88\"/><path d=\"M37 120 L52 92 L98 92 L113 120 Z\" fill=\"#FFCB2E\" opacity=\"0.88\"/><path d=\"M52 92 L64 66 L86 66 L98 92 Z\" fill=\"#FF8A3D\" opacity=\"0.88\"/><path d=\"M64 66 L73 44 L77 44 L86 66 Z\" fill=\"#FF5A6E\" opacity=\"0.88\"/><ellipse cx=\"75\" cy=\"44\" rx=\"16\" ry=\"5\" fill=\"#D43A2E\"/><circle cx=\"65\" cy=\"36\" r=\"4\" fill=\"#FF5A6E\"/><circle cx=\"75\" cy=\"28\" r=\"5\" fill=\"#FF5A6E\"/><circle cx=\"85\" cy=\"34\" r=\"4\" fill=\"#FF5A6E\"/><circle cx=\"71\" cy=\"24\" r=\"3\" fill=\"#FF5A6E\"/><circle cx=\"81\" cy=\"22\" r=\"3\" fill=\"#FF5A6E\"/><circle cx=\"69\" cy=\"32\" r=\"2\" fill=\"#FFCB2E\"/><circle cx=\"79\" cy=\"29\" r=\"2.4\" fill=\"#FFCB2E\"/><circle cx=\"75\" cy=\"20\" r=\"2\" fill=\"#FFCB2E\"/></svg>" }} />
          <div>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:10 }}>
              <span style={{ width:18, height:18, borderRadius:5, background:"#3FC66B", display:"inline-block" }} />
  ...
  if (card.type === "pinwheel") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 0 440 380\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M291 124 A74 74 0 0 1 262 166\" stroke=\"#F5A0B1\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" opacity=\"0.5\"/><path d=\"M168 157 A74 74 0 0 1 146 111\" stroke=\"#F5A0B1\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" opacity=\"0.5\"/><path d=\"M201 34 A74 74 0 0 1 251 38\" stroke=\"#F5A0B1\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" opacity=\"0.5\"/><path d=\"M220 105 L261 64 A58 58 0 0 1 261 146 Z\" fill=\"#FF9DBB\" stroke=\"#fff\" stroke-width=\"3\"/><path d=\"M220 105 L261 146 A58 58 0 0 1 179 146 Z\" fill=\"#8AC7FF\" stroke=\"#fff\" stroke-width=\"3\"/><path d=\"M220 105 L179 146 A58 58 0 0 1 179 64 Z\" fill=\"#FFD966\" stroke=\"#fff\" stroke-width=\"3\"/><path d=\"M220 105 L179 64 A58 58 0 0 1 261 64 Z\" fill=\"#7BE89B\" stroke=\"#fff\" stroke-width=\"3\"/><circle cx=\"220\" cy=\"105\" r=\"11\" fill=\"#9B6BFF\" stroke=\"#fff\" stroke-width=\"3\"/><rect x=\"216\" y=\"163\" width=\"8\" height=\"55\" rx=\"4\" fill=\"#B0784A\"/><ellipse cx=\"95\" cy=\"201\" rx=\"22\" ry=\"26\" fill=\"#8AC7FF\"/><circle cx=\"95\" cy=\"163\" r=\"22\" fill=\"#F0B583\"/><path d=\"M73 159 q22 -28 44 0 q-7 -18 -22 -18 q-15 0 -22 18 z\" fill=\"#6B4A2A\"/><circle cx=\"88\" cy=\"161\" r=\"2.8\" fill=\"#333\"/><circle cx=\"102\" cy=\"161\" r=\"2.8\" fill=\"#333\"/><ellipse cx=\"111\" cy=\"171\" rx=\"4.5\" ry=\"6\" fill=\"#C0392B\"/><circle cx=\"121\" cy=\"155\" r=\"7\" fill=\"#8AC7FF\" opacity=\"0.5\"/><circle cx=\"140\" cy=\"137\" r=\"9\" fill=\"#8AC7FF\" opacity=\"0.36\"/><circle cx=\"161\" cy=\"119\" r=\"11\" fill=\"#8AC7FF\" opacity=\"0.24\"/><text x=\"220\" y=\"240\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\" text-anchor=\"middle\">숨 길이 게이지</text><rect x=\"40\" y=\"250\" width=\"66\" height=\"36\" rx=\"8\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><text x=\"73\" y=\"274\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"17\" fill=\"#F0C8D6\" text-anchor=\"middle\">1</text><rect x=\"112\" y=\"250\" width=\"66\" height=\"36\" rx=\"8\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><text x=\"145\" y=\"274\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"17\" fill=\"#F0C8D6\" text-anchor=\"middle\">2</text><rect x=\"184\" y=\"250\" width=\"66\" height=\"36\" rx=\"8\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><text x=\"217\" y=\"274\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"17\" fill=\"#F0C8D6\" text-anchor=\"middle\">3</text><rect x=\"256\" y=\"250\" width=\"66\" height=\"36\" rx=\"8\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><text x=\"289\" y=\"274\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"17\" fill=\"#F0C8D6\" text-anchor=\"middle\">4</text><rect x=\"328\" y=\"250\" width=\"66\" height=\"36\" rx=\"8\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><text x=\"361\" y=\"274\" font-family=\"sans-serif\" font-weight=\"900\" font-size=\"17\" fill=\"#F0C8D6\" text-anchor=\"middle\">5</text><text x=\"40\" y=\"306\" font-family=\"sans-serif\" font-size=\"13\" fill=\"#888\">짧게</text><text x=\"400\" y=\"306\" font-family=\"sans-serif\" font-size=\"13\" fill=\"#888\" text-anchor=\"end\">아주 길게!</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "distance") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 0 440 210\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"4\" y=\"5\" width=\"432\" height=\"56\" rx=\"14\" fill=\"#fff\" stroke=\"#FF5A6E\" stroke-width=\"2.5\"/><circle cx=\"40\" cy=\"27\" r=\"8\" fill=\"#F0B583\"/><rect x=\"33\" y=\"35\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#FF8AAB\"/><circle cx=\"58\" cy=\"27\" r=\"8\" fill=\"#F0B583\"/><rect x=\"51\" y=\"35\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#8AC7FF\"/><text x=\"428\" y=\"29\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"end\">너무 가까워요</text><text x=\"428\" y=\"49\" font-family=\"sans-serif\" font-size=\"13\" fill=\"#888\" text-anchor=\"end\">뒤로 한 걸음</text><rect x=\"4\" y=\"71\" width=\"432\" height=\"56\" rx=\"14\" fill=\"#fff\" stroke=\"#3FC66B\" stroke-width=\"2.5\"/><circle cx=\"40\" cy=\"93\" r=\"8\" fill=\"#F0B583\"/><rect x=\"33\" y=\"101\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#FF8AAB\"/><circle cx=\"95\" cy=\"93\" r=\"8\" fill=\"#F0B583\"/><rect x=\"88\" y=\"101\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#8AC7FF\"/><text x=\"428\" y=\"95\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"end\">딱 좋아요</text><text x=\"428\" y=\"115\" font-family=\"sans-serif\" font-size=\"13\" fill=\"#888\" text-anchor=\"end\">이 정도!</text><rect x=\"4\" y=\"137\" width=\"432\" height=\"56\" rx=\"14\" fill=\"#fff\" stroke=\"#3FA0FF\" stroke-width=\"2.5\"/><circle cx=\"40\" cy=\"159\" r=\"8\" fill=\"#F0B583\"/><rect x=\"33\" y=\"167\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#FF8AAB\"/><circle cx=\"135\" cy=\"159\" r=\"8\" fill=\"#F0B583\"/><rect x=\"128\" y=\"167\" width=\"14\" height=\"18\" rx=\"4\" fill=\"#8AC7FF\"/><text x=\"428\" y=\"161\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"end\">너무 멀어요</text><text x=\"428\" y=\"181\" font-family=\"sans-serif\" font-size=\"13\" fill=\"#888\" text-anchor=\"end\">조금 가까이</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "turntable") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 0 440 240\" xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"150\" cy=\"120\" r=\"28\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"3\"/><path d=\"M150 98 l-9 18 h18 z\" fill=\"#9B6BFF\"/><circle cx=\"150\" cy=\"50\" r=\"22\" fill=\"#fff\" stroke=\"#FF9DBB\" stroke-width=\"2.5\"/><circle cx=\"150\" cy=\"45\" r=\"8\" fill=\"#F0B583\"/><rect x=\"141\" y=\"53\" width=\"18\" height=\"13\" rx=\"4\" fill=\"#FF9DBB\"/><rect x=\"128\" y=\"74\" width=\"44\" height=\"17\" rx=\"6\" fill=\"#FF9DBB\"/><text x=\"150\" y=\"86\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"12\" fill=\"#fff\" text-anchor=\"middle\">민준</text><circle cx=\"235\" cy=\"120\" r=\"22\" fill=\"#fff\" stroke=\"#8AC7FF\" stroke-width=\"2.5\"/><circle cx=\"235\" cy=\"115\" r=\"8\" fill=\"#F0B583\"/><rect x=\"226\" y=\"123\" width=\"18\" height=\"13\" rx=\"4\" fill=\"#8AC7FF\"/><rect x=\"213\" y=\"144\" width=\"44\" height=\"17\" rx=\"6\" fill=\"#8AC7FF\"/><text x=\"235\" y=\"156\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"12\" fill=\"#fff\" text-anchor=\"middle\">서연</text><circle cx=\"150\" cy=\"190\" r=\"22\" fill=\"#fff\" stroke=\"#7BE89B\" stroke-width=\"2.5\"/><circle cx=\"150\" cy=\"185\" r=\"8\" fill=\"#F0B583\"/><rect x=\"141\" y=\"193\" width=\"18\" height=\"13\" rx=\"4\" fill=\"#7BE89B\"/><rect x=\"128\" y=\"214\" width=\"44\" height=\"17\" rx=\"6\" fill=\"#7BE89B\"/><text x=\"150\" y=\"226\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"12\" fill=\"#fff\" text-anchor=\"middle\">지호</text><circle cx=\"65\" cy=\"120\" r=\"22\" fill=\"#fff\" stroke=\"#FFD966\" stroke-width=\"2.5\"/><circle cx=\"65\" cy=\"115\" r=\"8\" fill=\"#F0B583\"/><rect x=\"56\" y=\"123\" width=\"18\" height=\"13\" rx=\"4\" fill=\"#FFD966\"/><rect x=\"43\" y=\"144\" width=\"44\" height=\"17\" rx=\"6\" fill=\"#FFD966\"/><text x=\"65\" y=\"156\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"12\" fill=\"#fff\" text-anchor=\"middle\">하은</text><text x=\"300\" y=\"105\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\">화살표가</text><text x=\"300\" y=\"127\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\">가리키는</text><text x=\"300\" y=\"149\" font-family=\"sans-serif\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\">사람 차례!</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "syllable") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 236\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"48\" cy=\"115\" r=\"30\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><ellipse cx=\"39\" cy=\"105\" rx=\"10\" ry=\"6\" fill=\"#fff\" opacity=\"0.4\"/><circle cx=\"48\" cy=\"115\" r=\"18\" fill=\"#fff\" opacity=\"0.55\"/><circle cx=\"84.0\" cy=\"115\" r=\"3.5\" fill=\"#F5A0B1\"/><circle cx=\"120\" cy=\"115\" r=\"30\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><ellipse cx=\"111\" cy=\"105\" rx=\"10\" ry=\"6\" fill=\"#fff\" opacity=\"0.4\"/><circle cx=\"120\" cy=\"115\" r=\"18\" fill=\"#fff\" opacity=\"0.55\"/><circle cx=\"156.0\" cy=\"115\" r=\"3.5\" fill=\"#F5A0B1\"/><circle cx=\"192\" cy=\"115\" r=\"30\" fill=\"#FFD966\" filter=\"url(#sh)\"/><ellipse cx=\"183\" cy=\"105\" rx=\"10\" ry=\"6\" fill=\"#fff\" opacity=\"0.4\"/><circle cx=\"192\" cy=\"115\" r=\"18\" fill=\"#fff\" opacity=\"0.55\"/><circle cx=\"228.0\" cy=\"115\" r=\"3.5\" fill=\"#F5A0B1\"/><circle cx=\"264\" cy=\"115\" r=\"30\" fill=\"#7BE89B\" filter=\"url(#sh)\"/><ellipse cx=\"255\" cy=\"105\" rx=\"10\" ry=\"6\" fill=\"#fff\" opacity=\"0.4\"/><circle cx=\"264\" cy=\"115\" r=\"18\" fill=\"#fff\" opacity=\"0.55\"/><circle cx=\"300.0\" cy=\"115\" r=\"3.5\" fill=\"#F5A0B1\"/><circle cx=\"336\" cy=\"115\" r=\"30\" fill=\"#C9AEFF\" filter=\"url(#sh)\"/><ellipse cx=\"327\" cy=\"105\" rx=\"10\" ry=\"6\" fill=\"#fff\" opacity=\"0.4\"/><circle cx=\"336\" cy=\"115\" r=\"18\" fill=\"#fff\" opacity=\"0.55\"/><text x=\"220\" y=\"180\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">빈 동그라미에 목표 단어를 한 글자씩 써넣으세요</text><text x=\"220\" y=\"204\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#888\" text-anchor=\"middle\">하나씩 짚으며 또박또박 · 음절 추가 방지</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "slidewindow") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 231\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"50\" y=\"72\" width=\"340\" height=\"80\" rx=\"16\" fill=\"#fff\" filter=\"url(#sh)\"/><rect x=\"50\" y=\"72\" width=\"340\" height=\"80\" rx=\"16\" fill=\"none\" stroke=\"#F5A0B1\" stroke-width=\"2.5\"/><rect x=\"180\" y=\"80\" width=\"80\" height=\"64\" rx=\"10\" fill=\"#FFF8E0\" stroke=\"#FFCB2E\" stroke-width=\"2.5\"/><line x1=\"200\" y1=\"112\" x2=\"240\" y2=\"112\" stroke=\"#E0C068\" stroke-width=\"1.5\" stroke-dasharray=\"4 3\"/><circle cx=\"115\" cy=\"112\" r=\"20\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><path d=\"M120 104 l-9 8 9 8\" stroke=\"#fff\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><circle cx=\"325\" cy=\"112\" r=\"20\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><path d=\"M320 104 l9 8 -9 8\" stroke=\"#fff\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"220\" y=\"180\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">창(노란 칸)에 글자를 써서 하나씩 밀어 보여줘요</text><text x=\"220\" y=\"203\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#888\" text-anchor=\"middle\">한 글자씩 천천히 · 음절 늘리기/줄이기 연습</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "mouthshape") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 286\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"75\" cy=\"110\" r=\"34\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"63\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"87\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><ellipse cx=\"75\" cy=\"120\" rx=\"13\" ry=\"16\" fill=\"#C0392B\"/><ellipse cx=\"75\" cy=\"126\" rx=\"7\" ry=\"7\" fill=\"#E88\" opacity=\"0.7\"/><text x=\"75\" y=\"168\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#D4728A\" text-anchor=\"middle\">아</text><circle cx=\"185\" cy=\"110\" r=\"34\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"173\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"197\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><path d=\"M170 120 q15 10 30 0 q-15 4 -30 0 z\" fill=\"#C0392B\"/><rect x=\"171\" y=\"118\" width=\"28\" height=\"4\" rx=\"2\" fill=\"#fff\"/><text x=\"185\" y=\"168\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#D4728A\" text-anchor=\"middle\">이</text><circle cx=\"295\" cy=\"110\" r=\"34\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"283\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"307\" cy=\"100\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"295\" cy=\"122\" r=\"8\" fill=\"#C0392B\"/><circle cx=\"295\" cy=\"122\" r=\"4\" fill=\"#E88\" opacity=\"0.7\"/><text x=\"295\" y=\"168\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#D4728A\" text-anchor=\"middle\">우</text><circle cx=\"130\" cy=\"210\" r=\"34\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"118\" cy=\"200\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"142\" cy=\"200\" r=\"3\" fill=\"#5A4A3A\"/><ellipse cx=\"130\" cy=\"222\" rx=\"10\" ry=\"12\" fill=\"#C0392B\"/><ellipse cx=\"130\" cy=\"224\" rx=\"5\" ry=\"6\" fill=\"#E88\" opacity=\"0.7\"/><text x=\"130\" y=\"268\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#D4728A\" text-anchor=\"middle\">오</text><circle cx=\"240\" cy=\"210\" r=\"34\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"228\" cy=\"200\" r=\"3\" fill=\"#5A4A3A\"/><circle cx=\"252\" cy=\"200\" r=\"3\" fill=\"#5A4A3A\"/><path d=\"M227 218 q13 12 26 0 q-13 3 -26 0 z\" fill=\"#C0392B\"/><text x=\"240\" y=\"268\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#D4728A\" text-anchor=\"middle\">에</text><text x=\"360\" y=\"215\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\">입 모양을</text><text x=\"360\" y=\"235\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\">따라 해요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "pecs") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 236\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"75\" cy=\"120\" r=\"26\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"75\" cy=\"114\" r=\"11\" fill=\"#F0B583\"/><rect x=\"62\" y=\"125\" width=\"26\" height=\"18\" rx=\"6\" fill=\"#fff\" opacity=\"0.4\"/><text x=\"75\" y=\"172\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#D4728A\" text-anchor=\"middle\">아이</text><rect x=\"118\" y=\"102\" width=\"44\" height=\"36\" rx=\"6\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2.5\" filter=\"url(#sh)\"/><circle cx=\"140\" cy=\"116\" r=\"8\" fill=\"#FF8A3D\"/><rect x=\"130\" y=\"126\" width=\"20\" height=\"4\" rx=\"2\" fill=\"#3FC66B\"/><path d=\"M175 120 h55 M222 111 l10 9 -10 9\" stroke=\"#3FC66B\" stroke-width=\"4\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"202\" y=\"100\" font-family=\"Noto Sans CJK KR\" font-weight=\"700\" font-size=\"12\" fill=\"#3FC66B\" text-anchor=\"middle\">건네요</text><circle cx=\"310\" cy=\"120\" r=\"30\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"310\" cy=\"112\" r=\"13\" fill=\"#F0B583\"/><rect x=\"295\" y=\"125\" width=\"30\" height=\"20\" rx=\"6\" fill=\"#fff\" opacity=\"0.4\"/><text x=\"310\" y=\"176\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#D4728A\" text-anchor=\"middle\">선생님</text><text x=\"220\" y=\"180\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\" text-anchor=\"middle\">그림카드를 건네면 → 원하는 것을 받아요</text><text x=\"220\" y=\"204\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#888\" text-anchor=\"middle\">말 대신 그림으로 요청하기 (PECS 1단계)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "callcard") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 236\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"95\" cy=\"115\" r=\"34\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"95\" cy=\"104\" r=\"15\" fill=\"#F0B583\"/><path d=\"M80 120 q15 -14 30 0 z\" fill=\"#fff\" opacity=\"0.5\"/><rect x=\"66\" y=\"160\" width=\"58\" height=\"26\" rx=\"9\" fill=\"#FF9DBB\"/><text x=\"95\" y=\"178\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#fff\" text-anchor=\"middle\">○○</text><path d=\"M150 115 h70 M212 106 l12 9 -12 9\" stroke=\"#3FC66B\" stroke-width=\"4.5\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><rect x=\"245\" y=\"92\" width=\"150\" height=\"46\" rx=\"16\" fill=\"#3FC66B\" filter=\"url(#sh)\"/><text x=\"320\" y=\"121\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"19\" fill=\"#fff\" text-anchor=\"middle\">오세요</text><text x=\"220\" y=\"205\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">○○ 칸에 부를 사람(엄마·선생님)을 넣어 쓰세요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "naming") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 261\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"40\" y=\"70\" width=\"150\" height=\"120\" rx=\"16\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2.5\" stroke-dasharray=\"7 5\" filter=\"url(#sh)\"/><text x=\"115\" y=\"140\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"40\" fill=\"#F0C8D6\" text-anchor=\"middle\">?</text><text x=\"115\" y=\"205\" font-family=\"Noto Sans CJK KR\" font-size=\"12.5\" fill=\"#888\" text-anchor=\"middle\">사진·그림 붙이는 칸</text><path d=\"M205 130 h40 M238 121 l10 9 -10 9\" stroke=\"#3FC66B\" stroke-width=\"4\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><rect x=\"260\" y=\"95\" width=\"150\" height=\"70\" rx=\"18\" fill=\"#3FC66B\" filter=\"url(#sh)\"/><path d=\"M260 130 l-9 -5 v10 z\" fill=\"#3FC66B\"/><text x=\"335\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"17\" fill=\"#fff\" text-anchor=\"middle\">\"○○예요\"</text><text x=\"335\" y=\"150\" font-family=\"Noto Sans CJK KR\" font-size=\"12\" fill=\"#fff\" text-anchor=\"middle\" opacity=\"0.9\">이름 말하기</text><text x=\"220\" y=\"230\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\" text-anchor=\"middle\">\"이게 뭐예요?\" → 사물 이름을 말해요 (명명하기)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "corevocab") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 266\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"3\" y=\"52\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"58\" cy=\"82\" r=\"20\" fill=\"#3FC66B\"/><path d=\"M58 71 v22 M47 82 h22\" stroke=\"#fff\" stroke-width=\"4\" stroke-linecap=\"round\"/><text x=\"58\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">더</text><rect x=\"128\" y=\"52\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"183\" cy=\"82\" r=\"20\" fill=\"#FF8A3D\"/><path d=\"M183 90 C174 83 174 74 180 74 C183 74 183 78 183 79 C183 78 183 74 186 74 C192 74 192 83 183 90 Z\" fill=\"#fff\"/><text x=\"183\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">주세요</text><rect x=\"253\" y=\"52\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"308\" cy=\"82\" r=\"20\" fill=\"#FF5A6E\"/><rect x=\"297\" y=\"80\" width=\"22\" height=\"5\" rx=\"2.5\" fill=\"#fff\"/><text x=\"308\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">그만</text><rect x=\"3\" y=\"157\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"58\" cy=\"187\" r=\"20\" fill=\"#FF9DBB\"/><text x=\"58\" y=\"193\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"16\" fill=\"#fff\" text-anchor=\"middle\">!</text><text x=\"58\" y=\"233\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">도와줘</text><rect x=\"128\" y=\"157\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"183\" cy=\"187\" r=\"20\" fill=\"#3FA0FF\"/><path d=\"M174 187 l6 6 11-12\" stroke=\"#fff\" stroke-width=\"4\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"183\" y=\"233\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">네</text><rect x=\"253\" y=\"157\" width=\"110\" height=\"90\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"308\" cy=\"187\" r=\"20\" fill=\"#9B6BFF\"/><path d=\"M300 179 l16 16 M316 179 l-16 16\" stroke=\"#fff\" stroke-width=\"4\" stroke-linecap=\"round\"/><text x=\"308\" y=\"233\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\" text-anchor=\"middle\">아니요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "sentence") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 316\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"18\" y=\"62\" width=\"56\" height=\"40\" rx=\"10\" fill=\"#D4728A\"/><text x=\"46\" y=\"87\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#fff\" text-anchor=\"middle\">1어절</text><rect x=\"90\" y=\"60\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#FF9DBB\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"130\" y=\"88\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><rect x=\"18\" y=\"132\" width=\"56\" height=\"40\" rx=\"10\" fill=\"#D4728A\"/><text x=\"46\" y=\"157\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#fff\" text-anchor=\"middle\">2어절</text><rect x=\"90\" y=\"130\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#FF9DBB\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"130\" y=\"158\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><text x=\"174\" y=\"158\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"18\" fill=\"#F5A0B1\">+</text><rect x=\"194\" y=\"130\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#8AC7FF\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"234\" y=\"158\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><rect x=\"18\" y=\"202\" width=\"56\" height=\"40\" rx=\"10\" fill=\"#D4728A\"/><text x=\"46\" y=\"227\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#fff\" text-anchor=\"middle\">3어절</text><rect x=\"90\" y=\"200\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#FF9DBB\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"130\" y=\"228\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><text x=\"174\" y=\"228\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"18\" fill=\"#F5A0B1\">+</text><rect x=\"194\" y=\"200\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#8AC7FF\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"234\" y=\"228\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><text x=\"278\" y=\"228\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"18\" fill=\"#F5A0B1\">+</text><rect x=\"298\" y=\"200\" width=\"80\" height=\"44\" rx=\"12\" fill=\"#fff\" stroke=\"#FFD966\" stroke-width=\"2.5\" stroke-dasharray=\"6 4\" filter=\"url(#sh)\"/><text x=\"338\" y=\"228\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"20\" fill=\"#F0DDE6\" text-anchor=\"middle\">___</text><text x=\"220\" y=\"285\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\" text-anchor=\"middle\">빈 칸에 단어를 채워 점점 길게 (예: 공 → 공 주세요 → 빨간 공 주세요)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "relay") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 321\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"44\" cy=\"80\" r=\"20\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"44\" cy=\"76\" r=\"9\" fill=\"#F0B583\"/><path d=\"M33 95 q11 -12 22 0 z\" fill=\"#fff\" opacity=\"0.55\"/><rect x=\"74\" y=\"62\" width=\"150\" height=\"36\" rx=\"18\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><path d=\"M74 80 l-8 -4 v8 z\" fill=\"#FF9DBB\"/><circle cx=\"396\" cy=\"135\" r=\"20\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"396\" cy=\"131\" r=\"9\" fill=\"#F0B583\"/><path d=\"M385 150 q11 -12 22 0 z\" fill=\"#fff\" opacity=\"0.55\"/><rect x=\"216\" y=\"117\" width=\"150\" height=\"36\" rx=\"18\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><path d=\"M366 135 l8 -4 v8 z\" fill=\"#8AC7FF\"/><circle cx=\"44\" cy=\"190\" r=\"20\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"44\" cy=\"186\" r=\"9\" fill=\"#F0B583\"/><path d=\"M33 205 q11 -12 22 0 z\" fill=\"#fff\" opacity=\"0.55\"/><rect x=\"74\" y=\"172\" width=\"150\" height=\"36\" rx=\"18\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><path d=\"M74 190 l-8 -4 v8 z\" fill=\"#FF9DBB\"/><circle cx=\"396\" cy=\"245\" r=\"20\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"396\" cy=\"241\" r=\"9\" fill=\"#F0B583\"/><path d=\"M385 260 q11 -12 22 0 z\" fill=\"#fff\" opacity=\"0.55\"/><rect x=\"216\" y=\"227\" width=\"150\" height=\"36\" rx=\"18\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><path d=\"M366 245 l8 -4 v8 z\" fill=\"#8AC7FF\"/><path d=\"M220 107 q0 6 0 12\" stroke=\"#F5A0B1\" stroke-width=\"2.5\" fill=\"none\" marker-end=\"\"/><circle cx=\"220\" cy=\"121\" r=\"2.5\" fill=\"#F5A0B1\"/><path d=\"M220 162 q0 6 0 12\" stroke=\"#F5A0B1\" stroke-width=\"2.5\" fill=\"none\" marker-end=\"\"/><circle cx=\"220\" cy=\"176\" r=\"2.5\" fill=\"#F5A0B1\"/><path d=\"M220 217 q0 6 0 12\" stroke=\"#F5A0B1\" stroke-width=\"2.5\" fill=\"none\" marker-end=\"\"/><circle cx=\"220\" cy=\"231\" r=\"2.5\" fill=\"#F5A0B1\"/><text x=\"220\" y=\"290\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13.5\" fill=\"#D4728A\" text-anchor=\"middle\">내 차례 → 친구 차례, 한 번씩 주고받아요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "bodysignal") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 296\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"20\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" filter=\"url(#sh)\"/><rect x=\"20\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"none\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><path d=\"M44 90 q24 -12 48 0 q-3 15 -24 15 q-21 0 -24 -15 z\" fill=\"#FF8A3D\"/><ellipse cx=\"68\" cy=\"90\" rx=\"24\" ry=\"5\" fill=\"#FFB37A\"/><rect x=\"42\" y=\"103\" width=\"52\" height=\"5\" rx=\"2.5\" fill=\"#E0752E\"/><text x=\"110\" y=\"92\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"18\" fill=\"#D4728A\">배고파요</text><text x=\"110\" y=\"114\" font-family=\"Noto Sans CJK KR\" font-size=\"12\" fill=\"#888\">배가 꼬르륵</text><rect x=\"225\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" filter=\"url(#sh)\"/><rect x=\"225\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"none\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><path d=\"M259 74 h28 l-4 40 h-20 z\" fill=\"#fff\" stroke=\"#2ED4C4\" stroke-width=\"2.5\"/><path d=\"M262 94 h22 l-2.5 18 h-17 z\" fill=\"#2ED4C4\" opacity=\"0.6\"/><path d=\"M273 66 q3 3 0 6 q-3 -3 0 -6\" fill=\"#2ED4C4\"/><text x=\"315\" y=\"92\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"18\" fill=\"#D4728A\">목말라요</text><text x=\"315\" y=\"114\" font-family=\"Noto Sans CJK KR\" font-size=\"12\" fill=\"#888\">입이 말라요</text><rect x=\"20\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" filter=\"url(#sh)\"/><rect x=\"20\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"none\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><circle cx=\"68\" cy=\"200\" r=\"22\" fill=\"#9B6BFF\"/><ellipse cx=\"61\" cy=\"193\" rx=\"7\" ry=\"4\" fill=\"#fff\" opacity=\"0.35\"/><path d=\"M55 197 q5 5 10 0 M71 197 q5 5 10 0\" stroke=\"#fff\" stroke-width=\"2.4\" fill=\"none\" stroke-linecap=\"round\"/><text x=\"82\" y=\"188\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"13\" fill=\"#fff\">z</text><text x=\"110\" y=\"200\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"18\" fill=\"#D4728A\">피곤해요</text><text x=\"110\" y=\"222\" font-family=\"Noto Sans CJK KR\" font-size=\"12\" fill=\"#888\">눈이 무거워요</text><rect x=\"225\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" filter=\"url(#sh)\"/><rect x=\"225\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"none\" stroke=\"#F5A0B1\" stroke-width=\"2\"/><circle cx=\"273\" cy=\"200\" r=\"15\" fill=\"#FFCB2E\"/><line x1=\"292\" y1=\"200\" x2=\"298\" y2=\"200\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"286\" y1=\"213\" x2=\"291\" y2=\"218\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"273\" y1=\"219\" x2=\"273\" y2=\"225\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"260\" y1=\"213\" x2=\"255\" y2=\"218\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"254\" y1=\"200\" x2=\"248\" y2=\"200\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"260\" y1=\"187\" x2=\"255\" y2=\"182\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"273\" y1=\"181\" x2=\"273\" y2=\"175\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><line x1=\"286\" y1=\"187\" x2=\"291\" y2=\"182\" stroke=\"#FF8A3D\" stroke-width=\"2.6\" stroke-linecap=\"round\"/><path d=\"M293 208 q3 4 0 7 q-3 -3 0 -7\" fill=\"#3FA0FF\"/><text x=\"315\" y=\"200\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"18\" fill=\"#D4728A\">더워요</text><text x=\"315\" y=\"222\" font-family=\"Noto Sans CJK KR\" font-size=\"12\" fill=\"#888\">땀이 나요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "receptive") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 266\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"3\" y=\"55\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"58\" cy=\"77\" r=\"8\" fill=\"#F0B583\"/><path d=\"M49 87 v10 h4 v-8 M67 87 v10 h-4\" fill=\"none\" stroke=\"#FF9DBB\" stroke-width=\"5\" stroke-linecap=\"round\"/><rect x=\"56\" y=\"85\" width=\"5\" height=\"14\" fill=\"#FF9DBB\"/><rect x=\"47\" y=\"99\" width=\"22\" height=\"4\" rx=\"2\" fill=\"#B0784A\"/><text x=\"58\" y=\"135\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">앉아요</text><rect x=\"128\" y=\"55\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"183\" cy=\"75\" r=\"8\" fill=\"#F0B583\"/><rect x=\"178\" y=\"84\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#FF9DBB\"/><path d=\"M180 100 v6 M186 100 v6\" stroke=\"#F0B583\" stroke-width=\"4\" stroke-linecap=\"round\"/><path d=\"M183 67 v4\" stroke=\"#3FC66B\" stroke-width=\"3\" stroke-linecap=\"round\"/><path d=\"M180 69 l3 -3 3 3\" fill=\"none\" stroke=\"#3FC66B\" stroke-width=\"3\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"183\" y=\"135\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">일어서요</text><rect x=\"253\" y=\"55\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"308\" cy=\"78\" r=\"8\" fill=\"#F0B583\"/><path d=\"M305 89 v14 M311 89 v14\" stroke=\"#FF9DBB\" stroke-width=\"5\" stroke-linecap=\"round\"/><path d=\"M295 93 l8 4 M321 93 l-8 4\" stroke=\"#F0B583\" stroke-width=\"5\" stroke-linecap=\"round\"/><path d=\"M292 87 q-3 3 0 6 M324 87 q3 3 0 6\" stroke=\"#FFCB2E\" stroke-width=\"2\" fill=\"none\"/><text x=\"308\" y=\"135\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">박수 쳐요</text><rect x=\"3\" y=\"160\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"58\" cy=\"183\" r=\"8\" fill=\"#F0B583\"/><rect x=\"52\" y=\"192\" width=\"12\" height=\"13\" rx=\"4\" fill=\"#FF9DBB\"/><rect x=\"62\" y=\"194\" width=\"14\" height=\"10\" rx=\"3\" fill=\"#FFCB2E\"/><text x=\"58\" y=\"240\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">주세요</text><rect x=\"128\" y=\"160\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"183\" cy=\"183\" r=\"8\" fill=\"#F0B583\"/><rect x=\"177\" y=\"192\" width=\"12\" height=\"14\" rx=\"4\" fill=\"#FF9DBB\"/><path d=\"M189 196 l10 -6\" stroke=\"#F0B583\" stroke-width=\"5\" stroke-linecap=\"round\"/><circle cx=\"201\" cy=\"188\" r=\"3.5\" fill=\"#FF5A6E\"/><text x=\"183\" y=\"240\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">만져요</text><rect x=\"253\" y=\"160\" width=\"110\" height=\"92\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"308\" cy=\"183\" r=\"8\" fill=\"#F0B583\"/><rect x=\"302\" y=\"192\" width=\"12\" height=\"14\" rx=\"4\" fill=\"#FF9DBB\"/><path d=\"M314 196 q10 -2 8 6\" fill=\"none\" stroke=\"#F0B583\" stroke-width=\"5\" stroke-linecap=\"round\"/><text x=\"308\" y=\"240\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#3A2C30\" text-anchor=\"middle\">이리 와요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "bodyparts") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 326\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><path d=\"M138 150 q0 -88 82 -88 q82 0 82 88 q-22 -42 -82 -42 q-60 0 -82 42 z\" fill=\"#6B4A2A\"/><circle cx=\"220\" cy=\"175\" r=\"80\" fill=\"#FFE0C4\" filter=\"url(#sh)\"/><circle cx=\"140\" cy=\"175\" r=\"14\" fill=\"#FFE0C4\"/><circle cx=\"300\" cy=\"175\" r=\"14\" fill=\"#FFE0C4\"/><ellipse cx=\"192\" cy=\"159\" rx=\"13\" ry=\"10\" fill=\"#fff\"/><circle cx=\"192\" cy=\"159\" r=\"5.5\" fill=\"#3A2C30\"/><ellipse cx=\"248\" cy=\"159\" rx=\"13\" ry=\"10\" fill=\"#fff\"/><circle cx=\"248\" cy=\"159\" r=\"5.5\" fill=\"#3A2C30\"/><path d=\"M220 169 q-7 14 0 18 q7 -4 0 -18\" fill=\"#F0B583\"/><path d=\"M196 209 q24 18 48 0\" fill=\"none\" stroke=\"#C0392B\" stroke-width=\"4\" stroke-linecap=\"round\"/><line x1=\"179\" y1=\"159\" x2=\"125\" y2=\"159\" stroke=\"#FF5A6E\" stroke-width=\"2\"/><rect x=\"78\" y=\"144\" width=\"48\" height=\"30\" rx=\"15\" fill=\"#FF5A6E\" filter=\"url(#sh)\"/><text x=\"102\" y=\"165\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"15\" fill=\"#fff\" text-anchor=\"middle\">눈</text><line x1=\"314\" y1=\"175\" x2=\"340\" y2=\"175\" stroke=\"#9B6BFF\" stroke-width=\"2\"/><rect x=\"339\" y=\"160\" width=\"48\" height=\"30\" rx=\"15\" fill=\"#9B6BFF\" filter=\"url(#sh)\"/><text x=\"363\" y=\"181\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"15\" fill=\"#fff\" text-anchor=\"middle\">귀</text><line x1=\"220\" y1=\"183\" x2=\"150\" y2=\"215\" stroke=\"#3FA0FF\" stroke-width=\"2\"/><rect x=\"101\" y=\"205\" width=\"48\" height=\"30\" rx=\"15\" fill=\"#3FA0FF\" filter=\"url(#sh)\"/><text x=\"125\" y=\"226\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"15\" fill=\"#fff\" text-anchor=\"middle\">코</text><line x1=\"220\" y1=\"215\" x2=\"290\" y2=\"225\" stroke=\"#3FC66B\" stroke-width=\"2\"/><rect x=\"291\" y=\"215\" width=\"48\" height=\"30\" rx=\"15\" fill=\"#3FC66B\" filter=\"url(#sh)\"/><text x=\"315\" y=\"236\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"15\" fill=\"#fff\" text-anchor=\"middle\">입</text><text x=\"220\" y=\"295\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">\"눈 어디 있어요?\" 물으면 짚어요 (신체 부위)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "jointattn") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 316\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"80\" cy=\"140\" r=\"30\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"80\" cy=\"130\" r=\"13\" fill=\"#F0B583\"/><text x=\"80\" y=\"192\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#D4728A\" text-anchor=\"middle\">선생님</text><path d=\"M95 136 l45 -30\" stroke=\"#F0B583\" stroke-width=\"7\" stroke-linecap=\"round\"/><circle cx=\"142\" cy=\"104\" r=\"5\" fill=\"#F0B583\"/><path d=\"M150 100 L320 75\" stroke=\"#3FC66B\" stroke-width=\"2.5\" stroke-dasharray=\"7 5\" fill=\"none\"/><circle cx=\"340\" cy=\"80\" r=\"26\" fill=\"#FFCB2E\" filter=\"url(#sh)\"/><path d=\"M340 62 l5 12 13 1 -10 9 3 13 -11 -7 -11 7 3 -13 -10 -9 13 -1 z\" fill=\"#fff\"/><text x=\"340\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#D4728A\" text-anchor=\"middle\">저기!</text><circle cx=\"180\" cy=\"210\" r=\"24\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"180\" cy=\"202\" r=\"11\" fill=\"#F0B583\"/><circle cx=\"176\" cy=\"201\" r=\"2.5\" fill=\"#333\"/><circle cx=\"184\" cy=\"201\" r=\"2.5\" fill=\"#333\"/><text x=\"180\" y=\"252\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#D4728A\" text-anchor=\"middle\">아이도 봐요</text><path d=\"M188 201 L316 90\" stroke=\"#F5A0B1\" stroke-width=\"2\" stroke-dasharray=\"5 4\" fill=\"none\"/><text x=\"220\" y=\"285\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\" text-anchor=\"middle\">\"저기 봐!\" 가리키는 곳을 함께 봐요 (공동주의)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "eyecontact") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 291\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"115\" cy=\"150\" r=\"52\" fill=\"#DCEBF8\" filter=\"url(#sh)\"/><circle cx=\"115\" cy=\"150\" r=\"52\" fill=\"none\" stroke=\"#8AC7FF\" stroke-width=\"3\"/><circle cx=\"133\" cy=\"142\" r=\"11\" fill=\"#fff\"/><circle cx=\"139\" cy=\"142\" r=\"6\" fill=\"#3A2C30\"/><circle cx=\"109\" cy=\"142\" r=\"11\" fill=\"#fff\"/><circle cx=\"115\" cy=\"142\" r=\"6\" fill=\"#3A2C30\"/><path d=\"M105 168 q22 12 40 0\" fill=\"none\" stroke=\"#8A6A6A\" stroke-width=\"3\" stroke-linecap=\"round\"/><text x=\"115\" y=\"230\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">선생님</text><circle cx=\"325\" cy=\"150\" r=\"52\" fill=\"#FBDCE4\" filter=\"url(#sh)\"/><circle cx=\"325\" cy=\"150\" r=\"52\" fill=\"none\" stroke=\"#FF9DBB\" stroke-width=\"3\"/><circle cx=\"307\" cy=\"142\" r=\"11\" fill=\"#fff\"/><circle cx=\"301\" cy=\"142\" r=\"6\" fill=\"#3A2C30\"/><circle cx=\"331\" cy=\"142\" r=\"11\" fill=\"#fff\"/><circle cx=\"325\" cy=\"142\" r=\"6\" fill=\"#3A2C30\"/><path d=\"M315 168 q22 12 40 0\" fill=\"none\" stroke=\"#8A6A6A\" stroke-width=\"3\" stroke-linecap=\"round\"/><text x=\"325\" y=\"230\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#D4728A\" text-anchor=\"middle\">아이</text><path d=\"M145 142 L295 142\" stroke=\"#3FC66B\" stroke-width=\"3\" stroke-dasharray=\"7 5\"/><circle cx=\"220\" cy=\"142\" r=\"15\" fill=\"#3FC66B\"/><path d=\"M214 142 l4 4 8 -8\" stroke=\"#fff\" stroke-width=\"3\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"220\" y=\"255\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\" text-anchor=\"middle\">\"나 봐!\" 눈을 마주 봐요 (눈맞춤)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "imitate") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 306\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><text x=\"35\" y=\"88\" font-family=\"Noto Sans CJK KR\" font-weight=\"700\" font-size=\"12\" fill=\"#5B8BB5\">선생님</text><circle cx=\"90\" cy=\"95\" r=\"28\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"90\" cy=\"89\" r=\"12\" fill=\"#F0B583\"/><rect x=\"85\" y=\"99\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M84 101 L70 79\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><path d=\"M96 101 L110 79\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><circle cx=\"69\" cy=\"77\" r=\"4\" fill=\"#F0B583\"/><circle cx=\"111\" cy=\"77\" r=\"4\" fill=\"#F0B583\"/><path d=\"M90 130 v22 M84 144 l6 8 6 -8\" stroke=\"#3FC66B\" stroke-width=\"3.5\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><text x=\"35\" y=\"188\" font-family=\"Noto Sans CJK KR\" font-weight=\"700\" font-size=\"12\" fill=\"#D4728A\">아이</text><circle cx=\"90\" cy=\"190\" r=\"28\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"90\" cy=\"184\" r=\"12\" fill=\"#F0B583\"/><rect x=\"85\" y=\"194\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M84 196 L70 174\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><path d=\"M96 196 L110 174\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><circle cx=\"69\" cy=\"172\" r=\"4\" fill=\"#F0B583\"/><circle cx=\"111\" cy=\"172\" r=\"4\" fill=\"#F0B583\"/><text x=\"90\" y=\"238\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#3A2C30\" text-anchor=\"middle\">만세!</text><circle cx=\"220\" cy=\"95\" r=\"28\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"220\" cy=\"89\" r=\"12\" fill=\"#F0B583\"/><rect x=\"215\" y=\"99\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M214 99 q-14 -4 -6 -14\" stroke=\"#F0B583\" stroke-width=\"6\" fill=\"none\" stroke-linecap=\"round\"/><path d=\"M226 99 q14 -4 6 -14\" stroke=\"#F0B583\" stroke-width=\"6\" fill=\"none\" stroke-linecap=\"round\"/><path d=\"M220 130 v22 M214 144 l6 8 6 -8\" stroke=\"#3FC66B\" stroke-width=\"3.5\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><circle cx=\"220\" cy=\"190\" r=\"28\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"220\" cy=\"184\" r=\"12\" fill=\"#F0B583\"/><rect x=\"215\" y=\"194\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M214 194 q-14 -4 -6 -14\" stroke=\"#F0B583\" stroke-width=\"6\" fill=\"none\" stroke-linecap=\"round\"/><path d=\"M226 194 q14 -4 6 -14\" stroke=\"#F0B583\" stroke-width=\"6\" fill=\"none\" stroke-linecap=\"round\"/><text x=\"220\" y=\"238\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#3A2C30\" text-anchor=\"middle\">머리 짚기</text><circle cx=\"350\" cy=\"95\" r=\"28\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><circle cx=\"350\" cy=\"89\" r=\"12\" fill=\"#F0B583\"/><rect x=\"345\" y=\"99\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M344 103 L328 103\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><path d=\"M356 103 L372 103\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><circle cx=\"327\" cy=\"103\" r=\"4\" fill=\"#F0B583\"/><circle cx=\"373\" cy=\"103\" r=\"4\" fill=\"#F0B583\"/><path d=\"M350 130 v22 M344 144 l6 8 6 -8\" stroke=\"#3FC66B\" stroke-width=\"3.5\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><circle cx=\"350\" cy=\"190\" r=\"28\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><circle cx=\"350\" cy=\"184\" r=\"12\" fill=\"#F0B583\"/><rect x=\"345\" y=\"194\" width=\"10\" height=\"16\" rx=\"4\" fill=\"#fff\" opacity=\"0.5\"/><path d=\"M344 198 L328 198\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><path d=\"M356 198 L372 198\" stroke=\"#F0B583\" stroke-width=\"6\" stroke-linecap=\"round\"/><circle cx=\"327\" cy=\"198\" r=\"4\" fill=\"#F0B583\"/><circle cx=\"373\" cy=\"198\" r=\"4\" fill=\"#F0B583\"/><text x=\"350\" y=\"238\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"14\" fill=\"#3A2C30\" text-anchor=\"middle\">팔 벌려</text><text x=\"220\" y=\"272\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\" text-anchor=\"middle\">\"나처럼 해봐\" 선생님 동작을 똑같이 (동작 모방)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "animalsound") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 286\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"25\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"67\" cy=\"100\" r=\"26\" fill=\"#C68A52\"/><ellipse cx=\"45\" cy=\"86\" rx=\"9\" ry=\"14\" fill=\"#8A5A2A\" transform=\"rotate(-20 45 86)\"/><ellipse cx=\"89\" cy=\"86\" rx=\"9\" ry=\"14\" fill=\"#8A5A2A\" transform=\"rotate(20 89 86)\"/><circle cx=\"58\" cy=\"96\" r=\"3.5\" fill=\"#000\"/><circle cx=\"76\" cy=\"96\" r=\"3.5\" fill=\"#000\"/><ellipse cx=\"67\" cy=\"108\" rx=\"6\" ry=\"4.5\" fill=\"#000\"/><text x=\"120\" y=\"92\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\">강아지</text><rect x=\"115\" y=\"104\" width=\"88\" height=\"30\" rx=\"15\" fill=\"#FF9DBB\"/><text x=\"159\" y=\"124\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"16\" fill=\"#fff\" text-anchor=\"middle\">멍멍</text><rect x=\"230\" y=\"52\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"272\" cy=\"100\" r=\"26\" fill=\"#FFCB2E\"/><path d=\"M248 78 l6 16 -14 -4 z\" fill=\"#FFCB2E\"/><path d=\"M296 78 l-6 16 14 -4 z\" fill=\"#FFCB2E\"/><path d=\"M258 94 l7 3 M286 94 l-7 3\" stroke=\"#000\" stroke-width=\"2\" stroke-linecap=\"round\"/><circle cx=\"263\" cy=\"98\" r=\"3\" fill=\"#000\"/><circle cx=\"281\" cy=\"98\" r=\"3\" fill=\"#000\"/><path d=\"M272 106 l-3 3 3 2 3 -2 z\" fill=\"#E88\"/><text x=\"325\" y=\"92\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\">고양이</text><rect x=\"320\" y=\"104\" width=\"88\" height=\"30\" rx=\"15\" fill=\"#FF9DBB\"/><text x=\"364\" y=\"124\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"16\" fill=\"#fff\" text-anchor=\"middle\">야옹</text><rect x=\"25\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><ellipse cx=\"67\" cy=\"208\" rx=\"27\" ry=\"24\" fill=\"#fff\" stroke=\"#C9B08E\" stroke-width=\"2\"/><ellipse cx=\"55\" cy=\"198\" rx=\"8\" ry=\"6\" fill=\"#5A4A3A\"/><ellipse cx=\"81\" cy=\"214\" rx=\"7\" ry=\"5\" fill=\"#5A4A3A\"/><circle cx=\"58\" cy=\"206\" r=\"3.5\" fill=\"#000\"/><circle cx=\"76\" cy=\"206\" r=\"3.5\" fill=\"#000\"/><ellipse cx=\"67\" cy=\"220\" rx=\"12\" ry=\"8\" fill=\"#F0B0B8\"/><circle cx=\"63\" cy=\"220\" r=\"2\" fill=\"#000\"/><circle cx=\"71\" cy=\"220\" r=\"2\" fill=\"#000\"/><text x=\"120\" y=\"200\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\">소</text><rect x=\"115\" y=\"212\" width=\"88\" height=\"30\" rx=\"15\" fill=\"#FF9DBB\"/><text x=\"159\" y=\"232\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"16\" fill=\"#fff\" text-anchor=\"middle\">음메</text><rect x=\"230\" y=\"160\" width=\"195\" height=\"98\" rx=\"16\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"272\" cy=\"208\" r=\"26\" fill=\"#FFD966\"/><circle cx=\"274\" cy=\"204\" r=\"3.5\" fill=\"#000\"/><path d=\"M268 216 q-14 0 -14 6 q0 4 14 2 q10 -2 0 -8\" fill=\"#FF8A3D\"/><text x=\"325\" y=\"200\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#3A2C30\">오리</text><rect x=\"320\" y=\"212\" width=\"88\" height=\"30\" rx=\"15\" fill=\"#FF9DBB\"/><text x=\"364\" y=\"232\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"16\" fill=\"#fff\" text-anchor=\"middle\">꽥꽥</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "opposite") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 346\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><rect x=\"20\" y=\"52\" width=\"400\" height=\"82\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"80\" cy=\"93\" r=\"30\" fill=\"#FF8A3D\"/><text x=\"80\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">커요</text><text x=\"180\" y=\"100\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"24\" fill=\"#F5A0B1\" text-anchor=\"middle\">↔</text><circle cx=\"290\" cy=\"93\" r=\"13\" fill=\"#FF8A3D\"/><text x=\"290\" y=\"128\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">작아요</text><rect x=\"20\" y=\"144\" width=\"400\" height=\"82\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"50\" cy=\"175\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"72\" cy=\"175\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"94\" cy=\"175\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"50\" cy=\"197\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"72\" cy=\"197\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"94\" cy=\"197\" r=\"9\" fill=\"#3FC66B\"/><text x=\"80\" y=\"220\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">많아요</text><text x=\"180\" y=\"192\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"24\" fill=\"#F5A0B1\" text-anchor=\"middle\">↔</text><circle cx=\"285\" cy=\"185\" r=\"9\" fill=\"#3FC66B\"/><circle cx=\"300\" cy=\"185\" r=\"9\" fill=\"#3FC66B\"/><text x=\"290\" y=\"220\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">적어요</text><rect x=\"20\" y=\"236\" width=\"400\" height=\"82\" rx=\"14\" fill=\"#fff\" stroke=\"#F5A0B1\" stroke-width=\"2\" filter=\"url(#sh)\"/><circle cx=\"60\" cy=\"277\" r=\"15\" fill=\"#9B6BFF\"/><circle cx=\"100\" cy=\"277\" r=\"15\" fill=\"#9B6BFF\"/><text x=\"80\" y=\"312\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">같아요</text><text x=\"180\" y=\"284\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"24\" fill=\"#F5A0B1\" text-anchor=\"middle\">↔</text><circle cx=\"270\" cy=\"277\" r=\"15\" fill=\"#9B6BFF\"/><rect x=\"290\" y=\"262\" width=\"30\" height=\"30\" rx=\"4\" fill=\"#FFCB2E\"/><text x=\"295\" y=\"312\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"16\" fill=\"#D4728A\" text-anchor=\"middle\">달라요</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "sorting") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 326\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><text x=\"20\" y=\"70\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\">색깔 맞추기</text><circle cx=\"40\" cy=\"105\" r=\"24\" fill=\"#FF5A6E\" filter=\"url(#sh)\"/><text x=\"40\" y=\"145\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">빨강</text><circle cx=\"140\" cy=\"105\" r=\"24\" fill=\"#3FA0FF\" filter=\"url(#sh)\"/><text x=\"140\" y=\"145\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">파랑</text><circle cx=\"240\" cy=\"105\" r=\"24\" fill=\"#FFCB2E\" filter=\"url(#sh)\"/><text x=\"240\" y=\"145\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">노랑</text><circle cx=\"340\" cy=\"105\" r=\"24\" fill=\"#3FC66B\" filter=\"url(#sh)\"/><text x=\"340\" y=\"145\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">초록</text><text x=\"20\" y=\"185\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"15\" fill=\"#D4728A\">모양 맞추기</text><circle cx=\"60\" cy=\"220\" r=\"24\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><text x=\"60\" y=\"262\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">동그라미</text><rect x=\"136\" y=\"196\" width=\"48\" height=\"48\" rx=\"6\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><text x=\"160\" y=\"262\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">네모</text><path d=\"M260 196 l24 48 -48 0 z\" fill=\"#FFCB2E\" filter=\"url(#sh)\"/><text x=\"260\" y=\"262\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">세모</text><path d=\"M360 196 l7 16 17 1 -13 11 4 17 -15 -9 -15 9 4 -17 -13 -11 17 -1 z\" fill=\"#3FC66B\" filter=\"url(#sh)\"/><text x=\"360\" y=\"262\" font-family=\"Noto Sans CJK KR\" font-weight=\"800\" font-size=\"13\" fill=\"#3A2C30\" text-anchor=\"middle\">별</text><text x=\"220\" y=\"295\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\" text-anchor=\"middle\">같은 색·같은 모양끼리 모아요 (분류)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "counting") {
    return (
      <CardFrame title={card.title}>
        <div dangerouslySetInnerHTML={{ __html: "<svg width=\"100%\" viewBox=\"0 44 440 351\" xmlns=\"http://www.w3.org/2000/svg\"><defs><filter id=\"sh\" x=\"-20%\" y=\"-20%\" width=\"140%\" height=\"140%\"><feDropShadow dx=\"0\" dy=\"2\" stdDeviation=\"3\" flood-color=\"#D4728A\" flood-opacity=\"0.18\"/></filter></defs><circle cx=\"55\" cy=\"80\" r=\"22\" fill=\"#FF9DBB\" filter=\"url(#sh)\"/><text x=\"55\" y=\"88\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#fff\" text-anchor=\"middle\">1</text><circle cx=\"100\" cy=\"80\" r=\"13\" fill=\"#FF5A6E\"/><circle cx=\"55\" cy=\"128\" r=\"22\" fill=\"#8AC7FF\" filter=\"url(#sh)\"/><text x=\"55\" y=\"136\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#fff\" text-anchor=\"middle\">2</text><circle cx=\"100\" cy=\"128\" r=\"13\" fill=\"#3FA0FF\"/><circle cx=\"138\" cy=\"128\" r=\"13\" fill=\"#3FA0FF\"/><circle cx=\"55\" cy=\"176\" r=\"22\" fill=\"#FFD966\" filter=\"url(#sh)\"/><text x=\"55\" y=\"184\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#fff\" text-anchor=\"middle\">3</text><circle cx=\"100\" cy=\"176\" r=\"13\" fill=\"#E0A800\"/><circle cx=\"138\" cy=\"176\" r=\"13\" fill=\"#E0A800\"/><circle cx=\"176\" cy=\"176\" r=\"13\" fill=\"#E0A800\"/><circle cx=\"55\" cy=\"224\" r=\"22\" fill=\"#7BE89B\" filter=\"url(#sh)\"/><text x=\"55\" y=\"232\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#fff\" text-anchor=\"middle\">4</text><circle cx=\"100\" cy=\"224\" r=\"13\" fill=\"#3FC66B\"/><circle cx=\"138\" cy=\"224\" r=\"13\" fill=\"#3FC66B\"/><circle cx=\"176\" cy=\"224\" r=\"13\" fill=\"#3FC66B\"/><circle cx=\"214\" cy=\"224\" r=\"13\" fill=\"#3FC66B\"/><circle cx=\"55\" cy=\"272\" r=\"22\" fill=\"#C9AEFF\" filter=\"url(#sh)\"/><text x=\"55\" y=\"280\" font-family=\"Noto Sans CJK KR\" font-weight=\"900\" font-size=\"22\" fill=\"#fff\" text-anchor=\"middle\">5</text><circle cx=\"100\" cy=\"272\" r=\"13\" fill=\"#9B6BFF\"/><circle cx=\"138\" cy=\"272\" r=\"13\" fill=\"#9B6BFF\"/><circle cx=\"176\" cy=\"272\" r=\"13\" fill=\"#9B6BFF\"/><circle cx=\"214\" cy=\"272\" r=\"13\" fill=\"#9B6BFF\"/><circle cx=\"252\" cy=\"272\" r=\"13\" fill=\"#9B6BFF\"/><text x=\"220\" y=\"322\" font-family=\"Noto Sans CJK KR\" font-size=\"13\" fill=\"#5A5A66\" text-anchor=\"middle\">숫자만큼 하나씩 세어요 (1·2·3·4·5)</text></svg>" }} />
      </CardFrame>
    );
  }
  if (card.type === "compare") {
