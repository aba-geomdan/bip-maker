...
function visualCardToHtml(card, esc) {
  ...
  if (card.type === "counting") {
    return frame(`<div style="text-align:center;"><svg width="100%" viewBox="0 44 440 351" xmlns="http://www.w3.org/2000/svg"><defs><filter id="sh" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#D4728A" flood-opacity="0.18"/></filter></defs><circle cx="55" cy="80" r="22" fill="#FF9DBB" filter="url(#sh)"/><text x="55" y="88" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">1</text><circle cx="100" cy="80" r="13" fill="#FF5A6E"/><circle cx="55" cy="128" r="22" fill="#8AC7FF" filter="url(#sh)"/><text x="55" y="136" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">2</text><circle cx="100" cy="128" r="13" fill="#3FA0FF"/><circle cx="138" cy="128" r="13" fill="#3FA0FF"/><circle cx="55" cy="176" r="22" fill="#FFD966" filter="url(#sh)"/><text x="55" y="184" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">3</text><circle cx="100" cy="176" r="13" fill="#E0A800"/><circle cx="138" cy="176" r="13" fill="#E0A800"/><circle cx="176" cy="176" r="13" fill="#E0A800"/><circle cx="55" cy="224" r="22" fill="#7BE89B" filter="url(#sh)"/><text x="55" y="232" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">4</text><circle cx="100" cy="224" r="13" fill="#4CAF63"/><circle cx="138" cy="224" r="13" fill="#4CAF63"/><circle cx="176" cy="224" r="13" fill="#4CAF63"/><circle cx="214" cy="224" r="13" fill="#4CAF63"/><circle cx="55" cy="272" r="22" fill="#C9AEFF" filter="url(#sh)"/><text x="55" y="280" font-family="Noto Sans CJK KR" font-weight="900" font-size="22" fill="#fff" text-anchor="middle">5</text><circle cx="100" cy="272" r="13" fill="#9B6BFF"/><circle cx="138" cy="272" r="13" fill="#9B6BFF"/><circle cx="176" cy="272" r="13" fill="#9B6BFF"/><circle cx="214" cy="272" r="13" fill="#9B6BFF"/><circle cx="252" cy="272" r="13" fill="#9B6BFF"/><text x="220" y="322" font-family="Noto Sans CJK KR" font-size="13" fill="#5A5A66" text-anchor="middle">숫자만큼 하나씩 세어요 (1·2·3·4·5)</text></svg></div>`);
  }
